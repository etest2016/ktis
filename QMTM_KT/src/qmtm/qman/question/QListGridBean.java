...
public class QListGridBean {
	...
	public void setQ_ks(String q_ks) {
		this.q_ks = q_ks;
	}
	...
	public void setYn_ex_set(String yn_ex_set) {
		this.yn_ex_set = yn_ex_set;
	}
