...
public class TmanTree
{
	...
	public static TmanTreeBean[] getBeans(String id_category) throws QmTmException
    {
		...
		sql.append("SELECT id_course, course, yn_valid, to_char(regdate, 'yyyy-mm-dd') regdate, years ");
        ...
        try
        {
            ...
            throw new QmTmException("시험관리 과정 리스트 정보를 읽어오는 중 인터넷 연결상태가 좋지 않습니다.[TmanTree.getBeans]");
        }
        finally {
	...
	private static TmanTreeBean makeBeans (ResultSet rst) throws QmTmException
    {
		...
		try {
            ...
            throw new QmTmException("시험관리 과정 리스트 정보를 읽어오는 중 인터넷 연결상태가 좋지 않습니다.[TmanTree.makeBeans]");
        }
    }
	...
	public static TmanTreeBean getBean(String id_course) throws QmTmException 
	{
		...
		String sql = "SELECT course, yn_valid, to_char(regdate, 'yyyy-mm-dd') regdate FROM c_course WHERE id_course = ? ";
	    ...
	    try {
			...
			throw new QmTmException("시험관리 과정 정보를 읽어오는 중 인터넷 연결상태가 좋지 않습니다.[TmanTree.getBean]");
		} finally { 
			if (rst != null) try { rst.close(); } catch (SQLException ex) {}
			if (stm != null) try { stm.close(); } catch (SQLException ex) {}
			if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	private static TmanTreeBean makeBean (ResultSet rst) throws QmTmException
    {
		...
		try {
            ...
            throw new QmTmException("시험관리 과정 정보를 읽어오는 중 인터넷 연결상태가 좋지 않습니다.[TmanTree.makeBean]");
        }
    }
	...
	public static void insert(String id_course, String course, String years, String id_category) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("시험관리 과정 정보를 등록하는 중 인터넷 연결상태가 좋지 않습니다.[TmanTree.insert]");
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void update(String id_course, String course, String yn_valid, String id_category) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("시험관리 과정 정보를 수정하는 중 인터넷 연결상태가 좋지 않습니다.[TmanTree.update]");
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void update2(String id_course, String id_category) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("시험관리 과정 정보를 수정하는 중 인터넷 연결상태가 좋지 않습니다.[TmanTree.update2]");
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void delete(String id_course) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("시험관리 과정 정보를 삭제하는 중 인터넷 연결상태가 좋지 않습니다.[TmanTree.delete]");
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static TmanTreeBean[] getAddBeans(String id_course) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("문제관리 과목 정보를 읽어오는 중 인터넷 연결상태가 좋지 않습니다.[TmanTree.getAddBeans]");
        }
        finally {
            if (rst != null) try { rst.close(); } catch (SQLException ex) {}
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
	...
	private static TmanTreeBean makeAddBeans (ResultSet rst) throws QmTmException
    {
		try {
            ...
            throw new QmTmException("문제관리 과목 정보를 읽어오는 중 인터넷 연결상태가 좋지 않습니다.[TmanTree.makeAddBeans]");
        }
    }
