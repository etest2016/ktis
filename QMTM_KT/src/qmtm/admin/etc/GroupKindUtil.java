...
public class GroupKindUtil
{
	...
	public static GroupKindBean[] getBeans() throws QmTmException
    {
		...
		sql = "SELECT id_category, category, to_char(regdate, 'yyyy-mm-dd') regdate FROM c_category order by regdate desc ";
	...
	public static GroupKindBean[] getBeans2() throws QmTmException
    {
		...
		sql = "SELECT id_category, category, to_char(regdate, 'yyyy-mm-dd') regdate FROM c_category order by regdate ";
	...
	public static GroupKindBean[] getBeans2(String userid) throws QmTmException
    {
		...
		sql.append("SELECT a.id_category, a.category, to_char(a.regdate, 'yyyy-mm-dd') regdate ");
