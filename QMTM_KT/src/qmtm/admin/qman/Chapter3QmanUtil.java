...
public class Chapter3QmanUtil
{
	...
	public static Chapter3QmanBean[] getBeans(String id_q_chapter) throws QmTmException
    {
		...
		sql.append("Select id_q_chapter3, chapter, chapter_order, to_char(regdate, 'yyyy-mm-dd hh24:mi') regdate ");
	...
	public static Chapter3QmanBean getBean(String id_q_chapter) throws QmTmException 
	{
		...
		sql.append("SELECT id_q_subject, id_q_chapter, id_q_chapter2, id_q_chapter3, chapter, chapter_order, to_char(regdate, 'yyyy-mm-dd hh24:mi') regdate ");
