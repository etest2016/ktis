...
public class NameUtil
{
	...
	public static NameBean getSubject(String id_subject) throws QmTmException 
	{
	    ...
	    try {
			...
			throw new QmTmException("문제은행 과목 정보 읽어오는 중 인터넷 연결상태가 좋지 않습니다. [NameUtil.getSubject]");
		} finally { 
	...
	private static NameBean makeSubject (ResultSet rst) throws QmTmException
    {
		...
		try {
            ...
            throw new QmTmException("문제은행 과목 정보 읽어오는 중 인터넷 연결상태가 좋지 않습니다. [NameUtil.makeSubject]");
        }
    }
	...
	public static NameBean getChapter1(String id_chapter) throws QmTmException 
	{
	    ...
	    try {
			...
			throw new QmTmException("문제은행 카테고리 정보 읽어오는 중 인터넷 연결상태가 좋지 않습니다. [NameUtil.getChapter1]");
		} finally { 
			if (rst != null) try { rst.close(); } catch (SQLException ex) {}
			if (stm != null) try { stm.close(); } catch (SQLException ex) {}
			if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	private static NameBean makeChapter1 (ResultSet rst) throws QmTmException
    {
		...
		try {
            ...
            throw new QmTmException("문제은행 카테고리 정보 읽어오는 중 인터넷 연결상태가 좋지 않습니다. [NameUtil.makeChapter1]");
        }
    }
	...
	public static NameBean getChapter2(String id_chapter) throws QmTmException 
	{
	    ...
	    try {
			...
			throw new QmTmException("문제은행 카테고리 정보 읽어오는 중 인터넷 연결상태가 좋지 않습니다. [NameUtil.getChapter2]");
		} finally { 
			if (rst != null) try { rst.close(); } catch (SQLException ex) {}
			if (stm != null) try { stm.close(); } catch (SQLException ex) {}
			if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	private static NameBean makeChapter2 (ResultSet rst) throws QmTmException
    {
		...
		try {
            ...
            throw new QmTmException("문제은행 카테고리 정보 읽어오는 중 인터넷 연결상태가 좋지 않습니다. [NameUtil.makeChapter2]");
        }
    }
	...
	public static NameBean getChapter3(String id_chapter) throws QmTmException 
	{
	    ...
	    try {
			...
			throw new QmTmException("문제은행 카테고리 정보 읽어오는 중 인터넷 연결상태가 좋지 않습니다. [NameUtil.getChapter3]");
		} finally { 
			if (rst != null) try { rst.close(); } catch (SQLException ex) {}
			if (stm != null) try { stm.close(); } catch (SQLException ex) {}
			if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	private static NameBean makeChapter3 (ResultSet rst) throws QmTmException
    {
		...
		try {
            ...
            throw new QmTmException("문제은행 카테고리 정보 읽어오는 중 인터넷 연결상태가 좋지 않습니다. [NameUtil.makeChapter3]");
        }
    }
	...
	public static NameBean getChapter4(String id_chapter) throws QmTmException 
	{
	    ...
	    try {
			...
			throw new QmTmException("문제은행 카테고리 정보 읽어오는 중 인터넷 연결상태가 좋지 않습니다. [NameUtil.getChapter4]");
		} finally { 
			if (rst != null) try { rst.close(); } catch (SQLException ex) {}
			if (stm != null) try { stm.close(); } catch (SQLException ex) {}
			if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	private static NameBean makeChapter4 (ResultSet rst) throws QmTmException
    {
		...
		try {
            ...
            throw new QmTmException("문제은행 카테고리 정보 읽어오는 중 인터넷 연결상태가 좋지 않습니다. [NameUtil.makeChapter4]");
        }
    }
}