...
public class ExamInfo
{
    ...
    public static ExamInfoBean getBean(String id_exam) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("시험 정보 읽어오는 중 인터넷 연결상태가 좋지 않습니다. [ExamInfo.getBean]");
        }
        finally {
    ...
    private static ExamInfoBean makeBean (ResultSet rst) throws QmTmException
    {
        try {
            ...
            throw new QmTmException("시험 정보 읽어오는 중 인터넷 연결상태가 좋지 않습니다. [ExamInfo.makeBean]");
        }
    }
    ...
    public static String getExLabel(long id_exlabel) throws QmTmException
    {
        ...
        try {
            ...
            throw new QmTmException("보기 유형 정보 읽어오는 중 인터넷 연결상태가 좋지 않습니다. [ExamInfo.getExLabel]");
        } finally {
            if (rst != null) try { rst.close(); } catch (SQLException ex) {}
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
