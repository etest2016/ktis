...
public class User_ExamPaper2Bean
{
    private int nr_q;
    private long id_q;
    ...
    public void setQ(String q) {
        if (q == null) q = "";
        this.q = User_QmTm.delTag(q);
    }

    public void setEx1(String ex1) {
        if (ex1 == null) ex1 = "";
        this.ex1 = User_QmTm.delTag(ex1);
        int j = 0;
