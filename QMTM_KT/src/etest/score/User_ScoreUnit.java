...
public class User_ScoreUnit
{
    ...
    public static User_ScoreUnitBean getBean(String userid, String id_exam) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("성적조회할 응시자 정보를 읽어오는 중 인터넷 연결상태가 좋지 않습니다. [User_ScoreUnitBean.getBean]");
        } finally {
    ...
    {        
		try {
            ...
            throw new QmTmException("성적조회할 응시자 정보를 읽어오는 중 인터넷 연결상태가 좋지 않습니다. [User_ScoreUnitBean.makeBean]");
        }
    }
}
