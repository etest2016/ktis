...
<HTML>
 ...
 <script language="JavaScript">
	function sub_edit() {
		window.open("course_edit.jsp?id_course=<%=id_course%>","edit","width=400, height=250, scrollbars=no");
	}

	function sub_group_insert() {
		window.open("../sub_group_insert.jsp?id_course=<%=id_course%>","ginsert","width=550, height=550, scrollbars=yes");
    }
    ...
    function sub_delete()  {
       ...
       if (st == true) {
           window.open("course_delete.jsp?id_course=<%=id_course%>","edit","width=400, height=250, scrollbars=no");
       }
    }
	...
	function cpt_view(id_subject) {
		...
		window.open("../subject/subject_view.jsp?id_course=<%=id_course%>&id_subject="+id_subject,"view","width=400, height=250, scrollbars=no");
    }
 </script>
