...
<BODY ID="popup2">
	...
	<div id="top">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<Td id="left"></td>
				<Td id="mid"><div class="title">과목권한 수정 <span>선택 과목의 권한 수정</span></div></td>
				<Td id="right"></td>
			</tr>
		</table>
	</div>
	...
	<div id="contents" style="text-align: center;">
		...
		<TABLE border="0" cellpadding="0" cellspacing="0" id="tableD" width="100%">
			...
			<tr>
				...
				<td><input type="checkbox" name="q_edit" value="Y" <% if(rst2.getPt_q_edit().equals("Y")) { %> checked <% } %>></td>
			</tr>
			<tr>
				<td id="left">문제삭제권한&nbsp;</td>
				<td><input type="checkbox" name="q_del" value="Y" <% if(rst2.getPt_q_delete().equals("Y")) { %> checked <% } %>></td>
			</tr>
			<tr>
