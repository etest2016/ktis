 ...
 <BODY id="admin">	
   <div id="main">		
		<div id="mainTop">
			...
			<div class="location">ADMIN > 카테고리 관리 > <span>분야그룹</span></div>
		</div>
	...
	<table border="0" cellpadding ="0" cellspacing="0" id="tableA">		
		...
		<tr id="td" align="center">
			...
			<td><a href="../t_tree/f_main.jsp?id_category=<%=rst[i].getId_category()%>"><%=rst[i].getCategory()%></a></td>
