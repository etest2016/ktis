...
<%
	...
	if (id_q_chapter.length() == 0 || id_q_subject.length() == 0) {
...
<div id="button">
<img src="../../../images/bt5_edit_yj1.gif" onClick="send();" style="cursor:hand">&nbsp;&nbsp;<img border="0" src="../../../images/bt5_exit_yj1.gif" onClick="window.close();" style="cursor:hand">
</div>
