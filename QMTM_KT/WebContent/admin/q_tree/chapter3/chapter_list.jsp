...
//   모 듈 명 : 세번째 단원관리
//   설    명 : 문제은행 트리에서 세번째 단원 선택시 보여주는 페이지
//   테 이 블 : q_chapter3, q_chapter4  
//   자바파일 : qmtm.admin.Chapter3QmanBean, qmtm.admin.Chapter3QmanUtil
...
<HTML>
 ...
 <BODY id="admin">	
   <div id="main">
		...
		<div id="mainTop">
			<div class="title">선택 단원3 정보 <span>선택한 단원3의 상세정보 및 그 하위 단원을 조회 및 수정, 삭제 할 수 있습니다</span></div>
	...
	<div class="title">단원4 리스트</span></div>
			<table border="0" cellpadding ="0" cellspacing="0" id="tableA">
			<tr id="bt"><td colspan="4"><a href="javascript:cpt_insert();" onfocus="this.blur();"><img src="../../../images/bt_a_q_newc4.gif"></a></td></tr>
		<tr id="tr">
			<td width="7%">NO</td>
			<td>단원4코드</td>
			<td style="text-align: left;">단원4명</td>
			<td>등록일자</td>
		</tr>
		<% if(rst2 == null) { %>
		<tr>
			<td colspan="4" class="blank">등록되어진 단원4 이 없습니다.</td>
		</tr>
		<%
		   } else {
