...
<script language="javascript">
    // 단원 수정
	function cpt_edit() {
		location.href="chapter_edit.jsp?id_subject=<%=id_subject%>&id_q_subject=<%=id_q_subject%>&id_q_chapter=<%=id_q_chapter%>";
	}
    ...
    function cpt_delete()  {
       ...
       if (st == true) {
           document.location = "chapter_delete.jsp?id_subject=<%=id_subject%>&id_q_subject=<%=id_q_subject%>&id_q_chapter=<%=id_q_chapter%>";
       }
    }
</script>
</head>
