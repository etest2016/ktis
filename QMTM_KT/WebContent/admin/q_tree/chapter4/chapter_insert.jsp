...
<%
	...
	// 단원순서 가지고오기
	try {
		chapter_order = 1 + Chapter4QmanUtil.getCnt(id_q_chapter);
	} catch(Exception ex) {
...
<div id="top">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<Td id="left"></td>
				<Td id="mid"><div class="title">신규단원4 등록 <span>새 단원4을 등록합니다.</span></div></td>
				<Td id="right"></td>
			</tr>
		</table>
	</div>
...
<img src="../../../images/bt5_exit_yj1_11.gif" border="0" align="adsmiddle" style="cursor:hand" onClick="window.close();">
</div>		
</form>
