...
<%
	...
	if (userid.length() == 0 || id_subject.length() == 0 || id_chapter.length() == 0 || id_chapter2.length() == 0 || id_chapter3.length() == 0) {
...
%>
	...
	<table border="0" width="100%" cellpadding="0" cellspacing="0" id="tableA">
		...
		<tr bgcolor="#FFFFFF" height="40">
			<td colspan="7" align="center"  class="blank">검색되어진 문항이 없습니다.</td>
		</tr>
		<%
			} else {
