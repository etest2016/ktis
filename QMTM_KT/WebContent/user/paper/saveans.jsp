...
%>
      <script language="javascript">top.frames("fraTest").GetNext();</script>
<%
  } else if (moveType.equalsIgnoreCase("P")) {
%>
      <script language="javascript">top.frames("fraTest").GetPrevious();</script>
<%
  } else if (moveType.equalsIgnoreCase("C")) {
%>
      <script language="javascript">top.frames("fraTest").GetQ();</script>
<%
  } else {
...
<script language="javascript">
  ...
  if (window.name == "fraAction") {
    ...
    top.frames("fraTest").document.all.end_score.innerHTML = "<font size=6 color=red><b><i><%= userScore %></i></b></font>";
    <% } %>
    top.frames("fraTest").End_Msg();
  }
  else { <% /* called by retrySubmit */ %>
    <% if (yn_open_score_direct.equalsIgnoreCase("Y")) { %>
    opener.top.frames("fraTest").document.all.end_score.innerHTML = "<font size=6 color=red><b><i><%= userScore %></i></b></font>";
    <% } %>
    opener.top.frames("fraTest").End_Msg();
    close();
  }
