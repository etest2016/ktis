...
<HTML>
 <HEAD>
  ...
  <script language="JavaScript">
	function insert() {
		window.open("exam/exam_write.jsp?id_course=<%=id_course%>&id_subject=<%=id_subject%>","insert","width=750, height=640, scrollbars=no, top=0, left=0");
    }
	...
	function exam_copy() {
		window.open("exam/exam_copy.jsp?id_course=<%=id_course%>&id_subject=<%=id_subject%>","copys","top=0, left=0, width=650, height=450, scrollbars=yes");
    }

	function exam_copy_edit() {
		window.open("exam/exam_copy_edit.jsp?id_course=<%=id_course%>&id_subject=<%=id_subject%>","copys","top=0, left=0, width=650, height=450, scrollbars=yes");
    }

	function exam_delete() {
		window.open("exam/exam_deletes.jsp?id_course=<%=id_course%>&id_subject=<%=id_subject%>","deletes","width=650, height=450, scrollbars=yes, top=0, left=0");
    }

	function cpt_edit() {
		window.open("subject/subject_view.jsp?id_course=<%=id_course%>&id_subject=<%=id_subject%>","insert","width=400, height=250, scrollbars=no");
    }
 </script>
 ...
 <BODY id="tman">
	...
	<div id="main">
		...
		<div id="mainTop">
			<div class="title">과목 시험 리스트[과목명]<span></span></div>
			<div class="location">시험관리 > 과정 관리> <span>과목 관리</span></div>
		</div>
		...
		<table border="0" cellpadding ="0" cellspacing="0" id="tableA" >
			...
			<td align="right"><!--<input type="button" value="평가결과다운로드" class="form" onClick="exam_down();">&nbsp;&nbsp;--><input type="button" value="시험카테고리수정" class="form" onClick="cpt_edit();"></td></tr>
		</table>
