...
<%
	...
	response.setHeader("Content-Disposition", "attachment; filename=AnsPaper.htm");
...
<script language="JavaScript" type="text/javascript">
	...
	function answers_html() {
		window.open("answers_type_html.jsp?id_exam=<%=id_exam%>&userid=<%=userid%>&nr_set=<%=nr_set%>","answers_preview","width=1, height=1, scrollbars=no");
	}
	...
	<table width="90%" cellpadding="0" cellspacing="0" border="0" align="center">
		...
		<tr ID="id_answers_html">
			<td align="right" height="40px;" valign="top">
				<a href="javascript:answers_html();"><img src="../../images/bt2_html.gif"></a>&nbsp;<a href="javascript:window.close();"><img src="../../images/bt2_close.gif"></a>
			</td>
		</tr>
		<tr id="id_papers_html" STYLE="display: none;">
			<td align="right" height="40px;" valign="top">
				<a href="javascript:papers_htmL();"><img src="../../images/bt2_html.gif"></a>&nbsp;<a href="javascript:window.close();"><img src="../../images/bt2_close.gif"></a>
			</td>
		</tr>
		<tr>
			<td>
				<!--input type="button" value="응시자 답안" onClick="movieLayout('answers')"--><a href="javascript:movieLayout('answers');"><img src="../../images/bt_asn_weiw_answersyj1.gif"></a>&nbsp;<!--input type="button" value="응시자 시험지" onClick="movieLayout('papers')"--><a href="javascript:movieLayout('papers');"><img src="../../images/bt_asn_weiw_papersyj1.gif"></a>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				...
				<table border="0" cellpadding="0" cellspacing="0" id="tableA" >
					...
					<tr id="td2" align="center" <%if(i%2==1){%>bgcolor="#fafafa"<%}%>>
						...
						%>
							<textarea name="ans<%=i%>" cols="25" rows="10"><%=arrAnswer[i]%></textarea>
						<%
							} 
						%>
						</td>
