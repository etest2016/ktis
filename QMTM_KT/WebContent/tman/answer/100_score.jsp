...
<center>
<form name="form1" method="post" action="100_score_ok.jsp">
...
<table width="95%" border="0" cellpadding="1" cellspacing="1" bgcolor="#ffffff" style="width: 100%; border-top: 2px; solid #ffffff; font-size: 9pt;">
	...
	<tr bgcolor="#FFFFFF" style="background-color: #FCFCFC; border-top: 1px solid #a9da6d; border-bottom: 1px solid #a9da6d; border-right: 1px solid #a9da6d; border-left: 1px solid #a9da6d;">
		<td colspan="3"><font color="red"><b>100점 만점 환산점수 실행</b></font>&nbsp;&nbsp;&nbsp;<%if(score100_yn.equals("Y")) { %><a href="javascript:alert('기존에 100점 만점 환산점수로 실행을 하셨습니다.\n\n다시 실행하시려면 하단에 원점수로 복원하신 후에 실행해주시기 바랍니다.');"><% } else { %><a href="javascript:Send();"><% } %><img border="0" src="../../images/bt3_action.gif" align="absmiddle"></a>
		</td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td height="5" colspan="3"></td>
	...
	<tr bgcolor="#FFFFFF" height="50">
		<td colspan="3" valign="middle" style="background-color: #FCFCFC; border-top: 1px solid #a9da6d; border-bottom: 1px solid #a9da6d; border-right: 1px solid #a9da6d; border-left: 1px solid #a9da6d;"> 실행하기를 클릭하시면 해당 시험에 응시자 점수를 100점 만점으로 환산합니다.<br><br>ex)배점이 50점이고 응시자 점수가 40점일경우에는 100점 만점점수로 환산하면 90점이 됩니다.</td>
	</tr>
</table>
<br>
<table width="95%" border="0" cellpadding="1" cellspacing="1" bgcolor="#ffffff" style="width: 100%; border-top: 2px; solid #ffffff; font-size: 9pt;">
	<tr bgcolor="#FFFFFF" height="50">
		<td colspan="3" valign="middle" style="background-color: #FCFCFC; border-top: 1px solid #a9da6d; border-bottom: 1px solid #a9da6d; border-right: 1px solid #a9da6d; border-left: 1px solid #a9da6d;"> 기존에 100점 만점으로 환산을 실행하셨을 경우 점수를 아래 [클릭하기]를 이용해서 원점수로 복원 한 후에 실행해주시기 바랍니다.</td>
	</tr>
	...
	<tr bgcolor="#FFFFFF" height="40">
		<td ><font color="red"><b>100점 만점 환산점수 원점수로 복원</b></font>&nbsp;&nbsp;&nbsp;<%if(score100_yn.equals("Y")) { %><a href="javascript:score_reset();"><% } else { %><a href="javascript:alert('100점 만점 환산점수로 실행을 하신후에 이용하실 수 있습니다.');"><% } %>[클릭하기]</a></td>
	</tr>
