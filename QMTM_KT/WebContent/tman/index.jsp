...
<frameset rows="40, *" frameborder="NO" border="0" framespacing="0">
	...
	<frameset cols="250, *" frameborder="NO" border="0" framespacing="0">
		<frame name="fraLeft" src="f_left.jsp" frameborder="NO" marginwidth="0" marginheight="0">
		<frame name="fraMain" src="f_main.jsp" scrolling="YES" frameborder="NO" marginwidth="0" marginheight="0">
  </frameset>
</frameset>
