...
<head>
	...
	<script type="text/javascript">
		...
		<% if(rst == null) { %>
			...
			document.write("<BR>&nbsp;&nbsp;&nbsp;");
			document.write("<img src=\"../../images/base.gif\" align=\"absbottom\" alt=\"\" /><a href=\"course_create.jsp\" target=\"fraMain\" />카테고리 관리</a><br />");
			document.write("</div>");
		<% } else {
		...
		%>
			document.write("<div class='tree' style='position: absolute; top: -30px;  height: 365px; overflow-x:scroll; width: 200px;'>");
				createTree(Tree);
			document.write("</div>");
			document.write("<p>&nbsp;</p>");
			document.write("<p>&nbsp;</p>");
