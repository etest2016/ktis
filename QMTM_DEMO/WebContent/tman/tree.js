...
function preloadIcons() {
	...
	icons[6] = new Image();
	icons[6].src = "../images/folder2.gif";
	icons[7] = new Image();
	icons[7].src = "../images/folder2open.gif";
	icons[8] = new Image();
	icons[8].src = "../images/folder.gif";
	icons[9] = new Image();
...
function createTree(arrName, startNode, openNode) {
	...
	if (nodes.length > 0) {
		...
		if (startNode !=0) {
			...
			if(nodeValues[4] == "C1") {
				document.write("<a href=\"" + nodeValues[3] + "\" onmouseover=\"window.status='" + nodeValues[2] + "';return true;\" onmouseout=\"window.status=' ';return true;\"><img src=\"../images/folder2open.gif\" align=\"absbottom\" alt=\"\" />" + nodeValues[2] + "</a><br />");
			} else if(nodeValues[4] == "S1") {
		...
		} else document.write("<img src=\"../images/base.gif\" align=\"absbottom\" alt=\"\" /><a href=\"f_main.jsp\" target=\"fraMain\" />시험관리 카테고리</a><br />");
...
function addNode(parentNode, recursedNodes) {	
	for (var i = 0; i < nodes.length; i++) {
		...
		if (nodeValues[1] == parentNode) {
			...
			if (hcn) {
				if(nodeValues[4] == "C1") {
					document.write("<img id=\"icon" + nodeValues[0] + "\" src=\"../images/folder2")
				} else if(nodeValues[4] == "S1") {
				...
				if (nodeValues[4] == "E1") {
					...
					if(nodeValues[4] == "C1") {
						document.write("<img id=\"icon" + nodeValues[0] + "\" src=\"../images/folder2.gif\" align=\"absbottom\" alt=\"Folder\" />");
					} else if(nodeValues[4] == "S1") {
