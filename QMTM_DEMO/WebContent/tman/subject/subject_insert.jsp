...
<div id="top">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<Td id="left"></td>
				<Td id="mid"><div class="title">시험 단원 등록 <span>신규 단원을 등록합니다.</span></div></td>
				<Td id="right"></td>
			</tr>
		</table>
	</div>
	...
	<div id="contents" style="text-align: center;">
		<table style="border: 2px solid #ddd;">
			<tr height="50">
				...
				<td><img src="../../images/bt5_make_yj1_1.gif" onClick="checks();" style="cursor:hand">&nbsp;&nbsp;&nbsp;</td>
			</tr>
		</table>
	</div>
