...
<%
	...
	int refCnt = Integer.parseInt(request.getParameter("refCnt")); // 지문에 포함된 문항수
	int refGroupCnt = Integer.parseInt(request.getParameter("refGroupCnt")); // 지문 그룹수
	int orderCnt = Integer.parseInt(request.getParameter("orderCnt")); // 지문문항 Index
	int orderCnt2 = Integer.parseInt(request.getParameter("orderCnt2")); // 일반문항 Index
...
<BODY id="tman">
	...
	<table border=0 width="320" height="150" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC" valign="middle">
		...
		<tr bgcolor="#FFFFFF" height="40">
			<td align="right" width="70%" valign="middle" bgcolor="#DBDBDB">문항별 배점&nbsp;(추출문항별 배점)&nbsp;</td>
