...
<script language="javascript">	
	...
	function receipt_inwon() {
		window.open("receipt_group_inwons.jsp?id_exam=<%=id_exam%>","receipts","width=900, height=650, scorollbars=yes");
	}
...
<body id="popup2" onload="inits();">
	...
	<form name="form1" action="exam_group_update.jsp" method="post">
	...
	<div id="top">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<Td id="left"></td>
				<Td id="mid"><div class="title">시험일괄 수정 <span>선택된 시험에 대해서 일괄 수정합니다.</span></div></td>
				<Td id="right"></td>
			</tr>
		</table>
	</div>
	<div id="contents" style="height: 420px;">
		...
		<div style="display:;" id="id_basics">
			...
			<table border="0" width="100%" cellpadding ="0" cellspacing="0" id="tableD">
				<tr>
					<td id="left" width="100"><li>시험구분</td>
			...
			<table border="0" width="100%" cellpadding ="0" cellspacing="0" id="tableD">
				...
				<tr>
					...
					<td colspan="3"><div style="float: left; margin: 1px 7px 0px 3px;"><a href="javascript:" onClick="MiniCal(login_start1)"><img src="../../images/icon_cal.gif"></a></div><div style="float: left;"><input type="text" class="input" name="login_start1" size="12" readonly value="<%=now.toString().substring(0,10)%>">
				...
				<tr>
					...
					<td colspan="3"><div style="float: left; margin: 1px 7px 0px 3px;"><a href="javascript:" onClick="MiniCal(login_end1)"><img src="../../images/icon_cal.gif"></a></div><div style="float: left;"><input type="text" class="input" name="login_end1" size="12" readonly value="<%=now.toString().substring(0,10)%>">
				...
				<tr>
					...
					<td colspan="3"><div style="float: left; margin: 1px 7px 0px 3px;"><a href="javascript:" onClick="MiniCal(exam_start1)"><img src="../../images/icon_cal.gif"></a></div><div style="float: left;"><input type="text" class="input" name="exam_start1" size="12" readonly value="<%=now.toString().substring(0,10)%>">
				...
				<tr>
					...
					<td colspan="3"><div style="float: left; margin: 1px 7px 0px 3px;"><a href="javascript:" onClick="MiniCal(exam_end1)"><img src="../../images/icon_cal.gif"></a></div><div style="float: left;"><input type="text" class="input" name="exam_end1" size="12" readonly value="<%=now.toString().substring(0,10)%>">
		...
		<div style="display:none;" id="id_details">
			...
			<table border="0" width="100%" cellpadding ="0" cellspacing="0" id="tableD">
				...
				<tr>
					...
					<td><div style="float: left;"><input type="radio" name="id_auth_type" value="0" checked onClick="selects(0);">로그인&nbsp;&nbsp;&nbsp;<!--<input type="radio" name="id_auth_type" value="1" checked >과정&nbsp;&nbsp;&nbsp;--><input type="radio" name="id_auth_type" value="2"  onClick="selects(2);">접수</div><div id="receipts" style="float: left; margin-left: 20px;"><a href="javascript:receipt_inwon();" onfocus="this.blur();"><img src="../../images/bt_receipt_inwon_yj1.gif"></a></div></td>
				</tr>
			</table>
		...
		<div style="display:none;" id="id_scores"> 
			...
			<table border="0" width="100%" cellpadding ="0" cellspacing="0" id="tableD">
				...
				<tr>
					...
					<option value="C">답안 제출 직후 점수 및 정답해설 공개(모든문제보기)</option>
					<option value="F">답안 제출 직후 점수 및 정답해설 공개(틀린문제만보기)</option>
					<option value="D">성적 조회 기간에 점수만 공개</option>
					<option value="E">성적 조회 기간에 점수 및 정답해설 공개(모든문제보기)</option>
					<option value="G">성적 조회 기간에 점수 및 정답해설 공개(틀린문제만보기)</option>
					</select>
					</td>
				</tr>
				<tr>
					<td id="left"><li>성적조회 시작시간</td>
					<td><div style="float: left; margin: 1px 10px 0px 5px;"><a href="javascript:" onClick="MiniCal(stat_start1)"><img src="../../images/icon_cal.gif"></a></div><div style="float: left;"><input type="text" class="input" name="stat_start1" size="12" readonly value="<%=now.toString().substring(0,10)%>">
				...
				<tr>
					...
					<td><div style="float: left; margin: 1px 10px 0px 5px;"><a href="javascript:" onClick="MiniCal(stat_end1)"><img src="../../images/icon_cal.gif"></a></div><div style="float: left;"><input type="text" class="input" name="stat_end1" readonly size="12"  value="<%=now.toString().substring(0,10)%>">
				...
				<tr>
					...
					<td><input type="checkbox" name="yn_stat" value="Y" >응시자에게 성적통계 제공&nbsp;&nbsp;<input type="checkbox" name="yn_stat_r" value="Y" >단원별 요구수준 사용</td>
				</tr>
			</table>
		</div>
