...
<%@ page import="qmtm.*, qmtm.admin.etc.*, qmtm.tman.*, qmtm.admin.etc.GroupKindUtil, qmtm.tman.exam.*, java.sql.*, java.util.*" %>
...
<%	
	...
	try {
		id_category = GroupKindUtil.getId_category(id_course);
	} catch(Exception ex) {
		...
		<div style="display:;" id="id_basics">
			...
			<table border="0" width="100%" cellpadding ="0" cellspacing="0" id="tableD">
				...
				<tr>
					...
					<td colspan="3"><div style="float: left;"><input type="text" class="input date_picker" name="login_start1" size="12" readonly value="<%=now.toString().substring(0,10)%>">
				...
				<tr>
					...
					<td colspan="3"><div style="float: left;"><input type="text" class="input date_picker" name="login_end1" size="12" readonly value="<%=now.toString().substring(0,10)%>">
				...
				<tr>
					...
					<td colspan="3"><div style="float: left;"><input type="text" class="input date_picker" name="exam_start1" size="12" readonly value="<%=now.toString().substring(0,10)%>">
				...
				<tr>
					...
					<td colspan="3"><div style="float: left;"><input type="text" class="input date_picker" name="exam_end1" size="12" readonly value="<%=now.toString().substring(0,10)%>">
		...
		<div style="display:none;" id="id_designs">
			...
			<table border="0" width="100%" cellpadding ="0" cellspacing="0" id="tableD">
				<tr>
					...
					<td><input type="checkbox" name="web_window_mode" value="1" checked>&nbsp;시험지를 전체창으로 표시함</td>
				</tr>
			</table>
		</div>
