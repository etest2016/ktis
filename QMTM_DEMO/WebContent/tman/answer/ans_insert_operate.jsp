<%
//******************************************************************************
//   프로그램 : ans_insert_operate.jsp
//   모 듈 명 : 답안지 추가 2
//   설    명 : 답안지 추가 2
//   테 이 블 : exam_m, r_exlabel, exam_paper2, q, q_ref
//   자바파일 : qmtm.common.ExamInfo, qmtm.tman.answer.ExamUtil, qmtm.ExamPaper
//   작 성 일 : 2008-05-21
//   작 성 자 : 이테스트 석준호
//   수 정 일 : 
//   수 정 자 : 
...
<table border="0" width="100%">
	<tr height="25">
		<td align="left">&nbsp;<!--input type="button" value="HTML 저장" onClick="html_view();"--><a href="javascript:html_view();"><img src="../../images/bt_paper_html_yj1.gif"></a>&nbsp;<input type="image" value="답안 저장" name="submit" src="../../images/bt_ans_weiw_anssaveyj1.gif">&nbsp;<!--input type="button" value="나가기" onClick="window.close();"--><a href="javascript:window.close();"><img src="../../images/bt_ans_weiw_closeyj1.gif"></a></td>
	</tr>
</table>
...
<table cellpadding="1" cellspacing="1" bgcolor="#CCCCCC" border=0 width='100%'>
	<tr bgcolor="#DBDBDB" height="29" style="height: 29px; text-align: center; background-image: url(../../images/tablea_top3_exmake_yj1.gif);">
		<td align="center" width="5%">번호</td>
		<td align="center" width="17%">정답</td>
		<td align="center" width="40%">답안</td>
		<td align="center" width="5%">문제</td>
		<td align="center" width="10%">문제유형</td>
		<!--<td align="center" width="8%">난이도</td>-->
		<td align="center" width="8%">문제코드</td>
