...
function preloadIcons() {
	...
	icons[6] = new Image();
	icons[6].src = "../images/folder3.gif";
	icons[7] = new Image();
	icons[7].src = "../images/folder3open.gif";
	icons[8] = new Image();
...
function createTree(arrName, startNode, openNode) {
	...
	if (nodes.length > 0) {
		...
		if (startNode !=0) {
			...
			if(nodeValues[4] == "S1") {
				document.write("<a href=\"" + nodeValues[3] + "\" onmouseover=\"window.status='" + nodeValues[2] + "';return true;\" onmouseout=\"window.status=' ';return true;\"><img src=\"../images/folder3open.gif\" align=\"absbottom\" alt=\"\" />" + nodeValues[2] + "</a><br />");
			} else {
		...
		} else document.write("<img src=\"../images/base.gif\" align=\"absbottom\" alt=\"\" /><a href=\"f_main.jsp\" target=\"fraMain\" />巩力包府 墨抛绊府</a><br />");
...
function addNode(parentNode, recursedNodes) {	
	for (var i = 0; i < nodes.length; i++) {
		...
		if (nodeValues[1] == parentNode) {
			...
			if (hcn) {
				if(nodeValues[4] == "S1") {
					document.write("<img id=\"icon" + nodeValues[0] + "\" src=\"../images/folder3")
				} else {
				...
				if(nodeValues[4] == "S1") {
					document.write("<img id=\"icon" + nodeValues[0] + "\" src=\"../images/folder3.gif\" align=\"absbottom\" alt=\"Folder\" />");
				} else {
