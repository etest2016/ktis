...
<%
	...
	String a = new String(request.getParameter("a").getBytes("8859_1"),"EUC-KR");
	String b = new String(request.getParameter("b").getBytes("8859_1"),"EUC-KR");
	String c = new String(request.getParameter("c").getBytes("8859_1"),"EUC-KR");
	String d = new String(request.getParameter("d").getBytes("8859_1"),"EUC-KR");
	String e = new String(request.getParameter("e").getBytes("8859_1"),"EUC-KR");
	String f = new String(request.getParameter("f").getBytes("8859_1"),"EUC-KR");
	...
	<table border="0" cellpadding ="0" cellspacing="0" id="tableD">					
		...
		<tr>
			...
			<select name="h2" onChange="displays('h');">
				...
				<option value="팁" <%if(c.equals("팁")) { %>selected<% } %>>팁</option>
			</select>&nbsp;
