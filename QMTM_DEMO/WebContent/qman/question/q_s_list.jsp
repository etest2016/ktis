...
<%
	...
	if (id_q_chapter == null) { id_q_chapter = "0"; } else { id_q_chapter = id_q_chapter.trim(); }
 ...
 <HEAD>
  ...
  <!--
	...
	function cpt_insert() {
		...
		window.open("../../admin/q_tree/chapter/chapter_insert.jsp?id_q_subject=<%=id_q_subject%>","insert","width=400, height=250, scrollbars=no");
    }
