...
<BODY id="popup2">
	...
	<div id="button">
		...
		<input type="image" value="문제이동" name="submit" src="../../images/bt_q_move_yj1.gif">&nbsp;&nbsp;&nbsp;<!--input type="button" value="취소하기" onClick="window.close();"--><a href="javascript:window.close();"><img border="0" src="../../images/user_static_yj1_2.gif"></a>
