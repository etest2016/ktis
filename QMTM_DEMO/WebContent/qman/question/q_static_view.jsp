...
<BR><BR><BR>
		<table border="1" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC" width="100%" style="background-color: #FCFCFC; border-top: 2px solid #8b9eba; border-bottom: 2px solid #8b9eba; border-right: 2px solid #8b9eba; border-left: 2px solid #8b9eba;">
			<tr>
				<td><iframe src="q_static_graph.jsp?id_exam=<%=id_exam%>&id_q=<%=id_q%>" frameborder="0" name="q_graph_view" width="800" height="270"  marginwidth="0" marginheight="0" scrolling="auto"></iframe></td>
			</tr>
		</table>
</TD>
...
<div style="margin-top: 20px; text-align: center;">
		<img src="../../images/user_static_yj1_1.gif" onclick="javascript:window.close();" onfocus="this.blur();" style="cursor: hand;">
	</div>
