...
public class ExamList
{
	...
	public static ExamListBean[] getBeans(String id_course, String id_subject) throws QmTmException
    {
		...
		//sql.append("       convert(varchar(19), a.stat_end, 120) stat_end, a.userid, convert(varchar(19), a.regdate, 120) regdate, a.yn_open_qa ");
	...
	public static void reExamReg(String id_exam, String rid_exam) throws QmTmException {		
		...
		sql.append("Select '"+ id_exam +"', a.userid, 'Y', now() From qt_course_user a, exam_m b ");
