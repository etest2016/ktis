...
public class ExamAnswer {
	...
	private static ExamAnswerBean makeBean(ResultSet rst) throws QmTmException {
		try {
			...
			throw new QmTmException("응시자 답안지 정보를 읽어오는 중 인터넷 연결상태가 좋지 않습니다. [ExamAnswer.makeBean]");
		}
	}
	...
	public static ExamAnswerBean getBean(String userid, String id_exam) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("응시자 답안지 정보를 읽어오는 중 인터넷 연결상태가 좋지 않습니다. [ExamAnswer.getBean]");
		} finally {
	...
	public static ExamAnswerBean[] getBeans(String id_exam, String yn_end) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("응시자 답안지 정보를 읽어오는 중 인터넷 연결상태가 좋지 않습니다. [ExamAnswer.getBeans]");
		} finally {
			if (rst != null) 	try { rst.close(); } catch (SQLException ex) {}
			if (stm != null) 	try { stm.close(); } catch (SQLException ex) {}
			if (cnn != null) 	try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void insert(ExamAnswerBean bean) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("응시자 답안지를 등록하는 중 인터넷 연결상태가 좋지 않습니다. [ExamAnswer.insert]");
		} finally {
			if (stm != null)	try {	stm.close();	} catch (SQLException ex) {}
			if (cnn != null)	try {	cnn.close();	} catch (SQLException ex) {}
		}
	...
	public static void bakcopy2(String userid, String id_exam) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("응시자 답안지를 백업테이블로 이동하는 중 인터넷 연결상태가 좋지 않습니다. [ExamAnswer.bakcopy2]");
		} finally {
			if (stm != null)	try {	stm.close();	} catch (SQLException ex) {}
			if (cnn != null)	try {	cnn.close();	} catch (SQLException ex) {}
		}
	...
	public static void bakcopy(String userid, String id_exam) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("응시자 답안지를 백업테이블로 이동하는 중 인터넷 연결상태가 좋지 않습니다. [ExamAnswer.bakcopy]");
		} finally {
			if (stm != null)	try {	stm.close();	} catch (SQLException ex) {}
			if (cnn != null)	try {	cnn.close();	} catch (SQLException ex) {}
		}
	...
	public static void bakrestore(String userid, String id_exam) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("응시자 답안지를 복구하는 중 인터넷 연결상태가 좋지 않습니다. [ExamAnswer.bakrestore]");
		} finally {
			if (stm != null)	try {	stm.close();	} catch (SQLException ex) {}
			if (cnn != null)	try {	cnn.close();	} catch (SQLException ex) {}
		}
	...
	public static void update(String id_exam, String userid, ExamAnswerBean bean) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("응시자 답안지를 수정하는 중 인터넷 연결상태가 좋지 않습니다. [ExamAnswer.update]");
		} finally {
			if (stm != null)	try {	stm.close();	} catch (SQLException ex) {}
			if (cnn != null)	try {	cnn.close();	} catch (SQLException ex) {}
		}
	...
	public static void updateProc(String id_exam, String userid, double scores, String proc_res) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("응시자 답안지를 수정하는 중 인터넷 연결상태가 좋지 않습니다. [ExamAnswer.updateProc]");
		} finally {
			if (stm != null)	try {	stm.close();	} catch (SQLException ex) {}
			if (cnn != null)	try {	cnn.close();	} catch (SQLException ex) {}
		}
	...
	public static void ansY(String userid, String id_exam) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("응시자 답안지를 미완료에서 완료 처리하는 중 인터넷 연결상태가 좋지 않습니다. [ExamAnswer.ansY]");
		} finally {
			if (stm != null)	try {	stm.close();	} catch (SQLException ex) {}
			if (cnn != null)	try {	cnn.close();	} catch (SQLException ex) {}
		}
	...
	public static void ansN(String userid, String id_exam) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("응시자 답안지를 완료에서 미완료 처리하는 중 인터넷 연결상태가 좋지 않습니다. [ExamAnswer.ansN]");
		} finally {
			if (stm != null)	try {	stm.close();	} catch (SQLException ex) {}
			if (cnn != null)	try {	cnn.close();	} catch (SQLException ex) {}
		}
	...
	public static void delete(String userid, String id_exam) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("응시자 답안지를 삭제하는 중 인터넷 연결상태가 좋지 않습니다. [ExamAnswer.delete]");
		} finally {
			if (stm != null)	try {	stm.close();	} catch (SQLException ex) {}
			if (cnn != null)	try {	cnn.close();	} catch (SQLException ex) {}
		}
	...
	public static void bakdelete(String userid, String id_exam) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("응시자 답안지를 백업 테이블에서 삭제하는 중 인터넷 연결상태가 좋지 않습니다. [ExamAnswer.bakdelete]");
		} finally {
			if (stm != null)	try {	stm.close();	} catch (SQLException ex) {}
			if (cnn != null)	try {	cnn.close();	} catch (SQLException ex) {}
		}
	...
	public static void insertBlank(String userid, String id_exam, int setcount,
		...
		try {
			...
			throw new QmTmException("응시자 답안지를 등록하는 중 인터넷 연결상태가 좋지 않습니다. [ExamAnswer.insertBlank]");
		}
	}
	...
	public static void update_res(ExamAnswerBean bean) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("응시자 답안지를 수정하는 중 인터넷 연결상태가 좋지 않습니다. [ExamAnswer.update_res]");
		} finally {
			if (stm != null)	try {	stm.close();	} catch (SQLException ex) {}
			if (cnn != null)	try {	cnn.close();	} catch (SQLException ex) {}
		}
	...
	public static void setScoreOxs(ExamAnswerBean bean) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("응시자 답안지 채점을 진행하는 중 인터넷 연결상태가 좋지 않습니다. [ExamAnswer.setScoreOxs]");
		} finally {
			if (rst != null) try { rst.close(); } catch (SQLException ex) { }
			if (stm != null)	try {	stm.close();	} catch (SQLException ex) {}
			if (cnn != null)	try {	cnn.close();	} catch (SQLException ex) {}
