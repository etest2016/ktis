...
public class PaperNonExport
{
	...
	public static PaperNonExportBean getBeans(String id_exam, long id_q) throws QmTmException
    {
		...
		try
        {
			...
			throw new QmTmException("시험 문항 정보 읽어오는중 인터넷 연결상태가 좋지 않습니다. [PaperNonExport.getBeans]");
        }
        finally {
	...
	public static PaperNonExportBean[] getAllBeans(String id_exam) throws QmTmException
    {
		...
		try
        {
            ...
            throw new QmTmException("시험 논술형 문항 정보 읽어오는중 인터넷 연결상태가 좋지 않습니다. [PaperNonExport.getAllBeans]");
        }
        finally {
            if (rst != null) try { rst.close(); } catch (SQLException ex) {}
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
	...
	private static PaperNonExportBean makeAllBeans (ResultSet rst) throws QmTmException
    {
		...
		try {
			...
			throw new QmTmException("시험 문항 정보 읽어오는중 인터넷 연결상태가 좋지 않습니다. [PaperNonExport.makeAllBeans]");
        }
    }
	...
	public static PaperNonExportBean[] getAllBeans2(String id_exam, long id_q) throws QmTmException
    {
		...
		try
        {
            ...
            throw new QmTmException("시험 논술형 답안 정보 읽어오는중 인터넷 연결상태가 좋지 않습니다. [PaperNonExport.getAllBeans2]");
        }
        finally {
            if (rst != null) try { rst.close(); } catch (SQLException ex) {}
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
    ...
    private static PaperNonExportBean makeAllBeans2 (ResultSet rst) throws QmTmException
    {
		...
		try {
            ...
            throw new QmTmException("시험 논술형 답안 정보 읽어오는중 인터넷 연결상태가 좋지 않습니다. [PaperNonExport.makeAllBeans2]");
        }
    }
	...
	public static PaperNonExportBean[] getUserList(String id_exam, long id_q) throws QmTmException
    {
		...
		try
        {
            ...
            throw new QmTmException("논술형 답안 응시자 정보 읽어오는중 인터넷 연결상태가 좋지 않습니다. [PaperNonExport.getUserList]");
        }
        finally {
            if (rst != null) try { rst.close(); } catch (SQLException ex) {}
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
    ...
    private static PaperNonExportBean makeUserList (ResultSet rst) throws QmTmException
    {
		...
		try {
            ...
            throw new QmTmException("논술형 답안 응시자 정보 읽어오는중 인터넷 연결상태가 좋지 않습니다. [PaperNonExport.makeUserList]");
        }
    }
}