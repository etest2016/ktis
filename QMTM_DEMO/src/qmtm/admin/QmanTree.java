...
public class QmanTree
{
	...
	public static QmanTreeBean[] getBeans(String id_course) throws QmTmException
    {
		...
		sql.append("SELECT id_q_subject, q_subject, yn_valid, to_char(regdate, 'YYYY-MM-DD HH24:MI') regdate, id_category, years ");
	...
	public static QmanTreeBean getBean(String id_q_subject) throws QmTmException
	{
        ...
        String sql = "SELECT q_subject, yn_valid, to_char(regdate, 'YYYY-MM-DD HH24:MI') regdate, id_category, years FROM q_subject WHERE id_q_subject = ? ";
	...
	public static QmanTreeBean getBean_2(String id_q_subject) throws QmTmException
	{
		...
		sql.append("SELECT a.q_subject, a.yn_valid, to_char(a.regdate, 'YYYY-MM-DD HH24:MI') regdate, a.id_category, b.category ");
