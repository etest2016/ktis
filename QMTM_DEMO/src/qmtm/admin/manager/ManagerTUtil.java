...
public class ManagerTUtil
{
	...
	public static int getBeanCnt(String userid) throws QmTmException
    {
        ...
        try
        {
			...
			throw new QmTmException("시험관리 권한 정보를 읽어오는 중 인터넷 연결상태가 좋지 않습니다. [ManagerTUtil.getBeanCnt]");
        }
        finally {
	...
	public static ManagerTBean[] getBeans(String userid) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("교수자 시험관리 권한정보를 읽어오는 중 인터넷 연결상태가 좋지 않습니다. [ManagerTUtil.getBeans]");
        }
        finally {
            if (rst != null) try { rst.close(); } catch (SQLException ex) {}
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
    ...
    private static ManagerTBean makeBeans (ResultSet rst) throws QmTmException
    {
		try {
            ...
            throw new QmTmException("교수자 시험관리 권한정보를 읽어오는 중 인터넷 연결상태가 좋지 않습니다. [ManagerTUtil.makeBeans]");
        }
    }	
	...
	public static ManagerTBean getBean(String userid, String id_course) throws QmTmException 
	{
		...
		//sql.append("       a.pt_score_edit, a.pt_static_edit, convert(varchar(10), a.regdate, 120) regdate ");
	    ...
	    try {
			...
			throw new QmTmException("교수자 시험관리 권한정보를 읽어오는 중 인터넷 연결상태가 좋지 않습니다. [ManagerTUtil.getBean]");
		} finally { 
			if (rst != null) try { rst.close(); } catch (SQLException ex) {}
			if (stm != null) try { stm.close(); } catch (SQLException ex) {}
			if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static ManagerTBean[] getAddBeans(String userid) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("시험관리 과정정보를 읽어오는 중 인터넷 연결상태가 좋지 않습니다. [ManagerTUtil.getAddBeans]");
        }
        finally {
            if (rst != null) try { rst.close(); } catch (SQLException ex) {}
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
	...
	private static ManagerTBean makeAddBeans (ResultSet rst) throws QmTmException
    {
		try {
            ...
            throw new QmTmException("시험관리 과정정보를 읽어오는 중 인터넷 연결상태가 좋지 않습니다. [ManagerTUtil.makeAddBeans]");
        }
    }
	...
	public static void insert(String userid, String id_course, String exam_edit, String exam_del, String answer_edit, String score_edit, String static_edit) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("교수자 시험관리 권한정보를 등록하는 중 인터넷 연결상태가 좋지 않습니다. [ManagerTUtil.insert]");
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void update(String userid, String id_course, String exam_edit, String exam_del, String answer_edit, String score_edit, String static_edit) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("교수자 시험관리 권한정보를 수정하는 중 인터넷 연결상태가 좋지 않습니다. [ManagerTUtil.update]");
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void delete(String userid, String id_course) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("교수자 시험관리 권한정보를 삭제하는 중 인터넷 연결상태가 좋지 않습니다. [ManagerTUtil.delete]");
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
