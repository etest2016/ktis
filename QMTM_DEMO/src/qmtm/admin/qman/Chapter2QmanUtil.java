...
public class Chapter2QmanUtil
{
	...
	public static Chapter2QmanBean[] getBeans(String id_q_chapter) throws QmTmException
    {
		...
		//sql.append("Select id_q_chapter2, chapter, chapter_order, convert(varchar(16), regdate, 120) regdate ");
	...
	public static Chapter2QmanBean getBean(String id_q_chapter) throws QmTmException 
	{
		...
		//sql.append("SELECT id_q_subject, id_q_chapter, id_q_chapter2, chapter, chapter_order, convert(varchar(16), regdate, 120) regdate ");
