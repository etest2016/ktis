...
public class User_ExamAns
{
    ...
    private static User_ExamAnsBean makeBean (ResultSet rst) throws QmTmException
    {
        try {
            ...
            throw new QmTmException("응시자 답안지 정보 읽어오는중 인터넷 연결상태가 좋지 않습니다. [User_ExamAns.makeBean]");
        }
    }
    ...
    public static User_ExamAnsBean getBean(String userid, String id_exam) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("응시자 답안지 정보 읽어오는중 인터넷 연결상태가 좋지 않습니다. [User_ExamAns.getBean]");
        }
        finally {
    ...
    public static void insert(User_ExamAnsBean bean) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("응시자 답안지 저장하는중 인터넷 연결상태가 좋지 않습니다. [User_ExamAns.insert]"  + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
    ...
    public static void update(User_ExamAnsBean bean) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("응시자 답안지 수정하는중 인터넷 연결상태가 좋지 않습니다. [User_ExamAns.update]");
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
    ...
    public static void delete(String userid, String id_exam) throws QmTmException
    {
        ...
        try {
            ...
            throw new QmTmException("응시자 답안지 삭제하는중 인터넷 연결상태가 좋지 않습니다. [User_ExamAns.delete]");
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
    ...
    public static void insertBlank(String userid, String id_exam, int setcount, Timestamp system_now, long limittime, String user_ip) throws QmTmException
    {
        try {
            ...
            throw new QmTmException("응시자 답안지 저장하는중 인터넷 연결상태가 좋지 않습니다. [User_ExamAns.insertBlank]" + ex.getMessage());
        }
    }
    ...
    public static void setScoreOxs(User_ExamAnsBean bean) throws QmTmException
    {
        ...
        try
        {
         ...
         update(bean);
            ...
            throw new QmTmException("응시자 답안 채점 처리하는중 인터넷 연결상태가 좋지 않습니다. [User_ExamAns.setScoreOxs]");
        }
        finally {
            if (rst != null) try { rst.close(); } catch (SQLException ex) {}
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
