...
public class User_PaperList2 {
	...
	public static User_PaperList2Bean[] getBeans(String id_exam)
		...
		try {
			...
			throw new QmTmException("영역안내문 정보 읽어오는중 인터넷 연결상태가 좋지 않습니다. [User_PaperList2.getBeans]");
		} finally {
	...
	private static User_PaperList2Bean makeBeans(ResultSet rst) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("영역안내문 정보 읽어오는중 인터넷 연결상태가 좋지 않습니다. [User_PaperList2.makeBeans]");
		}
	}
}
