...
public class User_ScoreList
{
    ...
    public static User_ScoreListBean[] getBeans(String userid) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("성적조회할 시험정보를 읽어오는 중 오류가 발생되었습니다. [User_ScoreList.getBeans] " +ex.getMessage());
        }
        finally {
    ...
    private static User_ScoreListBean makeBeans (ResultSet rst) throws QmTmException
    {
        try {
            ...
            throw new QmTmException("성적조회할 시험정보를 읽어오는 중 오류가 발생되었습니다. [User_ScoreList.makeBeans] " +ex.getMessage());
        }
    }
    ...
    public static boolean isOpenScore(Timestamp from, Timestamp to) throws QmTmException
    {
		try {
            ...
            throw new QmTmException("성적조회기간 읽어오는 중 오류가 발생되었습니다. [User_ScoreList.isOpenScore] " +ex.getMessage());
        }
    }
}
