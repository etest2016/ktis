...
public class User_Log {
	...
	public static void saveLogText(String log_type, String id_exam,
		...
		try {
			...
			throw new QmTmException("응시자 로그 저장하는 중 오류가 발생되었습니다. [User_Log.saveLogText] " +ex.getMessage());
		}
	}
	...
	private static String readFile(String fullPathFileName) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("응시자 로그 읽어오는 중 오류가 발생되었습니다. [User_Log.readFile] " +ex.getMessage());
		}
	}
	...
	public static boolean deleteFile(String fileName) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("응시자 로그파일 삭제하는 중 오류가 발생되었습니다. [User_Log.deleteFile] " +ex.getMessage());
		}
	}
	...
	public static User_LogEventBean[] getLogEvents(String id_exam, String userid) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("응시자 로그 읽어오는 중 오류가 발생되었습니다. [User_Log.getLogEvents] " +ex.getMessage());
		}
	}
	...
	private static User_LogEventBean makeLogEventBean(String logEvent) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("응시자 로그 읽어오는 중 오류가 발생되었습니다. [User_Log.makeLogEventBean] " +ex.getMessage());
		}
	}
