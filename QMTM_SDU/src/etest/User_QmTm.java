...
public class User_QmTm
{
    ...
    public static String getName(String userid, String password) throws QmTmException
    {
        ...
        if(runMode.equals("ETEST_DEV")) {
        	sql = "SELECT NAME FROM QT_USERID WHERE (USERID = ?) AND (PWDCOMPARE(?,PASSWORD) = 1)";
        } else {
        ...
        try {
            ...
            throw new QmTmException("응시자 정보 읽어오는중 오류가 발생되었습니다. [User_QmTm.getName] " +ex.getMessage());
        } finally {
    ...
    public static String getNameBySSO(String userid) throws QmTmException
    {
    	Connection cnn = null; PreparedStatement stm = null; ResultSet rst = null; String sql = "";
    	String runMode = ComLib.getConfig("runmode");
    	sql = "SELECT NAME FROM QT_USERID WHERE (USERID = ?)";   	
    ...
    public static String getYn_end (String userid, String id_exam) throws QmTmException
    {
        ...
        try {
            ...
            throw new QmTmException("응시자 답안제출여부 읽어오는중 오류가 발생되었습니다. [User_QmTm.getYn_end] " +ex.getMessage());
        } finally {
            if (rst != null) try { rst.close(); } catch (SQLException ex) {}
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
    ...
    public static boolean hasReqForRetryExamBySuccessScore(String userid, String id_exam)  throws QmTmException
    {
    	String YnSuccessScore;
    	double SuccessScore;
    	double Score;
    	String OXS;
    	String YnEnd;
        ...
        sql = "";
		sql = sql + " SELECT ";
		sql = sql + " 	B.YN_SUCCESS_SCORE, B.SUCCESS_SCORE, A.SCORE, A.OXS, a.YN_END ";
		sql = sql + " FROM EXAM_ANS A  ";
		sql = sql + " JOIN EXAM_M B ON A.ID_EXAM = B.ID_EXAM ";
		sql = sql + " WHERE A.USERID = ? ";
		sql = sql + " AND A.ID_EXAM = ? ";        
        ...
        try {
            ...
            rst = stm.executeQuery();
            if (rst.next()) { 
            	YnSuccessScore = rst.getString("YN_SUCCESS_SCORE");
            	SuccessScore = rst.getDouble("SUCCESS_SCORE");
            	Score = rst.getDouble("SCORE");
            	OXS = rst.getString("OXS");
            	YnEnd = rst.getString("YN_END");
            }
            else { 
            	return false;
            }
        } catch (SQLException ex) {
            throw new QmTmException("응시자 합격점수설정에 의한 재응시자격조건을 읽어오는중 오류가 발생되었습니다. [User_QmTm.hasReqForRetryExamBySuccessScore] " +ex.getMessage());
        } finally {
            if (rst != null) try { rst.close(); } catch (SQLException ex) {}
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
        ...
        if(YnEnd.equals("Y") && YnSuccessScore.equals("Y") && (Score < SuccessScore) && (StringUtils.isEmpty(OXS) == false)) {
        	return true;
        } else {
        	return false;
        }
    ...
    public static Timestamp getEnd_time (String userid, String id_exam) throws QmTmException
    {
        ...
        try {
            ...
            throw new QmTmException("응시자 답안제출시간 읽어오는중 오류가 발생되었습니다. [User_QmTm.getEnd_time] " +ex.getMessage());
        } finally {
            if (rst != null) try { rst.close(); } catch (SQLException ex) {}
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static boolean hasAnswer (String userid, String id_exam) throws QmTmException
    {
        try {
            ...
            throw new QmTmException("응시자 답안제출여부 읽어오는중 오류가 발생되었습니다. [User_QmTm.hasAnswer] " +ex.getMessage());
        }
    }
    ...
    public static boolean hasSubmit (String userid, String id_exam) throws QmTmException
    {
        try {
            ...
            throw new QmTmException("응시자 답안제출여부 읽어오는중 오류가 발생되었습니다. [User_QmTm.hasSubmit] " +ex.getMessage());
        }
    }
    ...
    public static boolean isAuthTester (long id_auth_type, String userid, String id_exam) throws QmTmException
    {
        ...
        try {
			...
			throw new QmTmException("시험 대상자 여부 읽어오는중 오류가 발생되었습니다. [User_QmTm.isAuthTester] " +ex.getMessage());
        } finally {
            if (rst != null) try { rst.close(); } catch (SQLException ex) {}
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
