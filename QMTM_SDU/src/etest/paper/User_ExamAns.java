...
public class User_ExamAns
{
    ...
    private static User_ExamAnsBean makeBean (ResultSet rst) throws QmTmException
    {
        try {
            ...
            throw new QmTmException("응시자 답안지 정보 읽어오는중 오류가 발생되었습니다. [User_ExamAns.makeBean] " +ex.getMessage());
        }
    }
    ...
    public static User_ExamAnsBean getBean(String userid, String id_exam) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("응시자 답안지 정보 읽어오는중 오류가 발생되었습니다. [User_ExamAns.getBean] " +ex.getMessage());
        }
        finally {
    ...
    public static void insert(User_ExamAnsBean bean) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("응시자 답안지 저장하는중 오류가 발생되었습니다. [User_ExamAns.insert] " +ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
    ...
    public static void update(User_ExamAnsBean bean) throws QmTmException
    {
        ...
        sql.append("       SET NR_SET = ?, START_TIME = ?, END_TIME = ?, REMAIN_TIME = ?, ");
        ...
        try
        {
            ...
            throw new QmTmException("응시자 답안지 수정하는중 오류가 발생되었습니다. [User_ExamAns.update] " +ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
    ...
    public static void delete(String userid, String id_exam) throws QmTmException
    {
        ...
        try {
            ...
            throw new QmTmException("응시자 답안지 삭제하는중 오류가 발생되었습니다. [User_ExamAns.delete] " +ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
    ...
    public static void insertBlank(String userid, String id_exam, int setcount, Timestamp system_now, long limittime, String user_ip) throws QmTmException
    {
        try {
            ...
            throw new QmTmException("응시자 답안지 저장하는중 오류가 발생되었습니다. [User_ExamAns.insertBlank] " +ex.getMessage());
        }
    }
    ...
    public static void setScoreOxs(User_ExamAnsBean bean) throws QmTmException
    {
        ...
        sql.append("SELECT p.nr_q, p.allotting, q.id_qtype, q.ca, ");
        sql.append("       q.yn_caorder, q.yn_case, q.yn_blank, q.id_valid_type ");
        ...
        try
        {
            ...
            while (rst.next()) // 문제별
            {
                ...
                {
                    if (arrPoint[ndx].length() > 0){ point = Double.parseDouble(arrPoint[ndx]); } // 기존점수
                    else { point = 0; }
                    if (arrOX[ndx].length() > 0) { OX = arrOX[ndx];  }    // 기존 OX
                    else { OX = "X"; }
                }
                else // pointRate : 0 ~ 1
                {
         ...
         update(bean);
            ...
            throw new QmTmException("응시자 답안 채점 처리하는중 오류가 발생되었습니다. [User_ExamAns.setScoreOxs] " +ex.getMessage());
        }
        finally {
            if (rst != null) try { rst.close(); } catch (SQLException ex) {}
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
