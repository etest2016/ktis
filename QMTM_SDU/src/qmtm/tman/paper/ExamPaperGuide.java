...
public class ExamPaperGuide
{
	...
	public static void insert(ExamPaperGuideBean bean) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("영역 안내문 정보 등록하는 중 오류가 발생되었습니다. [ExamPaperGuide.insert] " + ex.getMessage());
        }
        finally {
	...
	public static void update(ExamPaperGuideBean bean, String id_exam, int nr_qs) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("영역 안내문 정보 수정하는 중 오류가 발생되었습니다. [ExamPaperGuide.update] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void delete(String id_exam, int nr_q) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("영역 안내문 정보 삭제하는 중 오류가 발생되었습니다. [ExamPaperGuide.delete] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static ExamPaperGuideBean[] getBeans(String id_exam) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("영역 안내문 정보 읽어오는 중 오류가 발생되었습니다. [ExamPaperGuide.getBeans] " + ex.getMessage());
        }
        finally {
    ...
    private static ExamPaperGuideBean makeBeans (ResultSet rst) throws QmTmException
    {
		...
		try {
            ...
            throw new QmTmException("영역 안내문 정보 읽어오는 중 오류가 발생되었습니다. [ExamPaperGuide.makeBeans] " + ex.getMessage());
        }
    }
	...
	public static ExamPaperGuideBean getBean(String id_exam, int nr_q) throws QmTmException 
	{
	    ...
	    try {
			...
			throw new QmTmException("영역 안내문 정보 읽어오는 중 오류가 발생되었습니다. [ExamPaperGuide.getBean] " + ex.getMessage());
		} finally { 
			if (rst != null) try { rst.close(); } catch (SQLException ex) {}
			if (stm != null) try { stm.close(); } catch (SQLException ex) {}
			if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	private static ExamPaperGuideBean makeBean (ResultSet rst) throws QmTmException
    {
		...
		try {
            ...
            throw new QmTmException("영역 안내문 정보 읽어오는 중 오류가 발생되었습니다. [ExamPaperGuide.makeBean] " + ex.getMessage());
        }
    }
	...
	public static int getPaperQcnt(String id_exam) throws QmTmException {
	    ...
	    try {
            ...
            throw new QmTmException("시험지 출제문제 갯수 정보 읽어오는 중 오류가 발생되었습니다. [ExamPaperGuide.getPaperQcnt] " + ex.getMessage());
        } finally {
            if (rst != null) try { rst.close(); } catch (SQLException ex) {}
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
