...
public class ExamPaperQ
{
	...
	public static void saveQ(String q, String allott, String id_exam) throws QmTmException
    {
        ...
        sql.append("Select b.id_q, ?, b.id_subject, a.q_subject, b.id_chapter, c.chapter, substring(b.q,0,500), ");
		sql.append("       b.id_ref, b.id_qtype, b.id_difficulty1, ?, b.excount, 1, 0, 0 ");
		sql.append("From q_subject as a inner join q as b ");
		sql.append("     on b.id_q = ? and a.id_q_subject = b.id_subject ");
        ...
        try
        {
			...
			stm.setString(2, allott);
			stm.setString(3, q);
			stm.executeUpdate();
        }
        catch (SQLException ex) {
            throw new QmTmException("시험지 만들기에서 출제문제 저장 중 오류가 발생되었습니다. [ExamPaperQ.saveQ] " + ex.getMessage());
        }
        finally {
	...
	public static void saveQ2(String qs, String id_exam) throws QmTmException
    {
        ...
        sql.append("INSERT INTO q_paper ");
        sql.append("Select b.id_q, '"+ id_exam +"', b.id_subject, a.q_subject, b.id_chapter, c.chapter, substring(b.q,0,500), ");
        ...
        try
        {
            ...
            throw new QmTmException("시험지 만들기에서 출제문제 저장 중 오류가 발생되었습니다. [ExamPaperQ.saveQ2] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static boolean getPapers(String id_exam) throws QmTmException
    {
        ...
        try {
            ...
            throw new QmTmException("시험지 만들기에서 시험코드 읽어오는 중 오류가 발생되었습니다. [ExamPaperQ.getPapers] " + ex.getMessage());
        } finally {
	...
	public static void delete(String id_exam) throws QmTmException
	{
        ...
        try
        {
            ...
            throw new QmTmException("시험지 만들기에서 출제문제 삭제 중 오류가 발생되었습니다. [ExamPaperQ.delete] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void updateOrders(String id_exam, String id_subject, int id_qtype, int orders, int ch_qs, double ch_score) throws QmTmException
	{
        ...
        try
        {
            ...
            throw new QmTmException("시험지 만들기에서 출제문제 정보 수정 중 오류가 발생되었습니다. [ExamPaperQ.updateOrders] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void updateOrders2(String id_exam, String id_subject, String id_chapter, int orders, int ch_qs, double ch_score) throws QmTmException
	{
        ...
        try
        {
            ...
            throw new QmTmException("시험지 만들기에서 출제문제 정보 수정 중 오류가 발생되었습니다. [ExamPaperQ.updateOrders2] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void updateOrders3(String id_exam, String id_subject, String id_chapter, int id_qtype, int orders, int ch_qs, double ch_score) throws QmTmException
	{
        ...
        try
        {
            ...
            throw new QmTmException("시험지 만들기에서 출제문제 정보 수정 중 오류가 발생되었습니다. [ExamPaperQ.updateOrders3] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void updateOrders4(String id_exam, String id_subject, String id_chapter, int id_difficulty, int orders, int ch_qs, double ch_score) throws QmTmException
	{
        ...
        try
        {
            ...
            throw new QmTmException("시험지 만들기에서 출제문제 정보 수정 중 오류가 발생되었습니다. [ExamPaperQ.updateOrders4] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void updateOrders5(String id_exam, String id_subject, String id_chapter, int id_qtype, int id_difficulty, int orders, int ch_qs, double ch_score) throws QmTmException
	{
        ...
        try
        {
            ...
            throw new QmTmException("시험지 만들기에서 출제문제 정보 수정 중 오류가 발생되었습니다. [ExamPaperQ.updateOrders5] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void updateOrders6(String id_exam, String id_subject, int orders, int ch_qs, double ch_score) throws QmTmException
	{
        ...
        try
        {
            ...
            throw new QmTmException("시험지 만들기에서 출제문제 정보 수정 중 오류가 발생되었습니다. [ExamPaperQ.updateOrders6] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void updateRefOrders(String id_exam, int orders) throws QmTmException
	{
        ...
        try
        {
            ...
            throw new QmTmException("시험지 만들기에서 출제문제 정보 수정 중 오류가 발생되었습니다. [ExamPaperQ.updateRefOrders] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
