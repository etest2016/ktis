...
public class ChapterScore
{
	...
	public static ChapterScoreBean[] getBeans(String id_exam) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("단원 정보 읽어오는 중 오류가 발생되었습니다. [ChapterScore.getBeans] " + ex.getMessage());
        }
        finally {
    ...
    {		
		try {
            ...
            throw new QmTmException("단원 정보 읽어오는 중 오류가 발생되었습니다. [ChapterScore.makeBeans] " + ex.getMessage());
        }
    }
	...
	public static double getScore(String id_exam, String id_chapter) throws QmTmException
	{
		...
		try {
            ...
            throw new QmTmException("문제은행 단원2 정보 읽어오는 중 오류가 발생되었습니다. [ChapterScore.getCnt] " + ex.getMessage());
        } finally {
            if (rst != null) try { rst.close(); } catch (SQLException ex) {}
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void insert(String id_exam, String id_chapter, double score) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("단원별 요구수준 점수 등록 중 오류가 발생되었습니다. [ChapterScore.insert] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void delete(String id_exam, String id_chapter, double score) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("단원별 요구수준 점수 삭제 중 오류가 발생되었습니다. [ChapterScore.delete] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
