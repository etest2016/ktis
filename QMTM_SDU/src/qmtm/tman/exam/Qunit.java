...
public class Qunit
{
	...
	public static QunitBean getBean(long id_q) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("문제정보를 읽어오는 중 오류가 발생되었습니다. [Qunit.getBean] " +ex.getMessage());
        }
        finally {
	...
	private static QunitBean makeBean (ResultSet rst) throws QmTmException
    {
		try {
            ...
            throw new QmTmException("문제정보를 읽어오는 중 오류가 발생되었습니다. [Qunit.makeBean] " +ex.getMessage());
        }
    }
	...
	public static QunitBean getQBean(long id_q) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("문제정보를 읽어오는 중 오류가 발생되었습니다. [Qunit.getQBean] " +ex.getMessage());
        }
        finally {
            if (rst != null) try { rst.close(); } catch (SQLException ex) {}
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
	...
	private static QunitBean makeQBean (ResultSet rst) throws QmTmException
    {
		try {
            ...
            throw new QmTmException("문제정보를 읽어오는 중 오류가 발생되었습니다. [Qunit.makeQBean] " +ex.getMessage());
        }
    }
	...
	public static QunitBean[] getBeans(String id_qs) throws QmTmException
    {
        ...
        try
        {
			...
			throw new QmTmException("문제정보를 읽어오는 중 오류가 발생되었습니다. [Qunit.getBeans] " +ex.getMessage());
		} finally {
			if (rst != null) try { rst.close(); } catch (SQLException ex) {}
			if (stm != null)	try {	stm.close();	} catch (SQLException ex) {}
			if (cnn != null)	try {	cnn.close();	} catch (SQLException ex) {}
	...
	public static QunitBean[] getBeans2(String id_qs, String id_subject, String id_chapter) throws QmTmException
    {
        Connection cnn = null; Statement stm = null; ResultSet rst = null;
		StringBuffer sql = new StringBuffer();
		...
		sql.append("       a.ex5, a.ex6, a.ex7, a.ex8, a.ca, c.reftitle, c.refbody1, c.refbody2, c.refbody3 ");
		sql.append("From q as a inner join r_qtype as b ");
		sql.append("     on a.id_q in (" + id_qs + ") and a.id_subject = '" + id_subject + "' and a.id_chapter = '" + id_chapter + "' and a.id_qtype = b.id_qtype ");
		sql.append("     left outer join q_ref as c on a.id_ref = c.id_ref ");
        ...
        try
        {
			...
			throw new QmTmException("문제정보를 읽어오는 중 오류가 발생되었습니다. [Qunit.getBeans2] " +ex.getMessage());
		} finally {
			if (rst != null) try { rst.close(); } catch (SQLException ex) {}
			if (stm != null)	try {	stm.close();	} catch (SQLException ex) {}
			if (cnn != null)	try {	cnn.close();	} catch (SQLException ex) {}
