...
public class ExtendTime
{
	...
	public static void delete(String id_exam, String userid, int extend_time) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("개인별 제한시간 삭제 중 오류가 발생되었습니다. [ExtendTime.delete] " + ex.getMessage());
        }
        finally {
	...
	public static void insert(String id_exam, String userid, int extend_time) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("개인별 제한시간 등록 중 오류가 발생되었습니다. [ExtendTime.insert] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void allDelete(String id_exam, int extend_time) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("미완료자 제한시간 삭제 중 오류가 발생되었습니다. [ExtendTime.allDelete] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void allInsert(String id_exam, int extend_time) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("미완료자 제한시간 등록 중 오류가 발생되었습니다. [ExtendTime.allInsert] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void pDelete(ExtendTimeBean bean) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("개인시간 삭제 작업 중 오류가 발생되었습니다. [ExtendTime.pDelete] " + ex.getMessage());	
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void pInsert(ExtendTimeBean bean) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("개인시간 변경 작업 중 오류가 발생되었습니다. [ExtendTime.pInsert] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void handicapDelete(String id_exam, String userid, int extend_time) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("장애학우 시간연장 삭제 작업 중 오류가 발생되었습니다. [ExtendTime.handicapDelete] " + ex.getMessage());	
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void handicapInsert(String id_exam, String userid, int extend_time) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("장애학우 제한시간 등록 중 오류가 발생되었습니다. [ExtendTime.handicapInsert] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static ExtendTimeBean[] getExtendTimeList(String id_exam) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("개인별 시간연장정보 읽어오는 중 오류가 발생되었습니다. [ExtendTime.getExtendTimeList] " + ex.getMessage());
        }
        finally {
    ...
    private static ExtendTimeBean makeExtendTime (ResultSet rst) throws QmTmException
    {
		try {
            ...
            throw new QmTmException("개인별 시간연장정보 읽어오는 중 오류가 발생되었습니다. [ExtendTime.makeExtendTime] " + ex.getMessage());
        }
    }
	...
	public static ExtendTimeBean getExtendTime(String id_exam, String userid) throws QmTmException 
	{
	    ...
	    try {
			...
			throw new QmTmException("개인별 시간연장정보 읽어오는 중 오류가 발생되었습니다. [PersonalTime2.getExtendTime] " + ex.getMessage());	
		} finally { 
			if (rst != null) try { rst.close(); } catch (SQLException ex) {}
			if (stm != null) try { stm.close(); } catch (SQLException ex) {}
			if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	private static ExtendTimeBean makeExtendTime2 (ResultSet rst) throws QmTmException
    {
		try {
            ...
            throw new QmTmException("개인별 시간연장정보 읽어오는 중 오류가 발생되었습니다. [ExtendTime.makeExtendTime2] " + ex.getMessage());
        }
    }
	...
	public static void extendTimeUpdate(String id_exam, String userid) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("남은시간 연장 관련 수정완료 중 오류가 발생되었습니다. [ExtendTime.extendTimeUpdate] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void remainTimeUpdate(String id_exam, String userid, int lngExtTime) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("시험시간 연장 관련 수정완료 중 오류가 발생되었습니다. [ExtendTime.remainTimeUpdate] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
