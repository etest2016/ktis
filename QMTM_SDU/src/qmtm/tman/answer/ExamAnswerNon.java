...
public class ExamAnswerNon {
	...
	private static ExamAnswerNonBean makeBean(ResultSet rst) throws QmTmException {
		try {
			...
			throw new QmTmException("논술형 답안정보를 읽어오는 중 오류가 발생되었습니다. [ExamAnswerNon.makeBean] " + ex.getMessage());
		}
	}
	...
	public static ExamAnswerNonBean getBean(long id_q, String userid, String id_exam) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("논술형 답안정보를 읽어오는 중 오류가 발생되었습니다. [ExamAnswerNon.getBean] " + ex.getMessage());
		} finally {
	...
	public static void insert(ExamAnswerNonBean bean) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("논술형 답안을 등록하는 중 오류가 발생되었습니다. [ExamAnswerNon.insert] " + ex.getMessage());
		} finally {
			if (stm != null)	try {	stm.close();	} catch (SQLException ex) {}
			if (cnn != null)	try {	cnn.close();	} catch (SQLException ex) {}
		}
	...
	public static void update(String id_exam, String userid, long id_q, ExamAnswerNonBean bean) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("논술형 답안을 수정하는 중 오류가 발생되었습니다. [ExamAnswerNon.update] " + ex.getMessage());
		} finally {
			if (stm != null)	try {	stm.close();	} catch (SQLException ex) {}
			if (cnn != null)	try {	cnn.close();	} catch (SQLException ex) {}
		}
	...
	public static void delete(long id_q, String userid, String id_exam) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("논술형 답안을 삭제하는 중 오류가 발생되었습니다. [ExamAnswerNon.delete] " + ex.getMessage());
		} finally {
			if (stm != null)	try {	stm.close();	} catch (SQLException ex) {}
			if (cnn != null)	try {	cnn.close();	} catch (SQLException ex) {}
		}
	...
	public static void insertBlanks(String userid, String id_exam, int nr_set) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("논술형 답안을 등록하는 중 오류가 발생되었습니다. [ExamAnswerNon.insertBlanks] " + ex.getMessage());
		} finally {
			if (stm != null)	try {	stm.close();	} catch (SQLException ex) {}
			if (cnn != null)	try {	cnn.close();	} catch (SQLException ex) {}
		}
	...
	public static void bakcopy2(String userid, String id_exam) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("백업테이블에 논술형 답안을 등록하는 중 오류가 발생되었습니다. [ExamAnswerNon.bakcopy2] " + ex.getMessage());
		} finally {
			if (stm != null)	try {	stm.close();	} catch (SQLException ex) {}
			if (cnn != null)	try {	cnn.close();	} catch (SQLException ex) {}
		}
	...
	public static void bakcopy(String userid, String id_exam) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("백업테이블에 논술형 답안을 등록하는 중 오류가 발생되었습니다. [ExamAnswerNon.bakcopy] " + ex.getMessage());
		} finally {
			if (stm != null)	try {	stm.close();	} catch (SQLException ex) {}
			if (cnn != null)	try {	cnn.close();	} catch (SQLException ex) {}
		}
	...
	public static void bakrestore(String userid, String id_exam) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("백업테이블에 논술형 답안을 복구하는 중 오류가 발생되었습니다. [ExamAnswerNon.bakrestore] " + ex.getMessage());
		} finally {
			if (stm != null)	try {	stm.close();	} catch (SQLException ex) {}
			if (cnn != null)	try {	cnn.close();	} catch (SQLException ex) {}
		}
	...
	public static void deleteForBlanks(String userid, String id_exam) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("논술형 답안을 삭제하는 중 오류가 발생되었습니다. [ExamAnswerNon.deleteForBlanks] " + ex.getMessage());
		} finally {
			if (stm != null)	try {	stm.close();	} catch (SQLException ex) {}
			if (cnn != null)	try {	cnn.close();	} catch (SQLException ex) {}
		}
	...
	public static void bakdelete(String userid, String id_exam) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("백업테이블에 논술형 답안을 삭제하는 중 오류가 발생되었습니다. [ExamAnswerNon.bakdelete] " + ex.getMessage());
		} finally {
			if (stm != null)	try {	stm.close();	} catch (SQLException ex) {}
			if (cnn != null)	try {	cnn.close();	} catch (SQLException ex) {}
		}
