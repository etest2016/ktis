...
public class PracticeMarkNon
{
    public PracticeMarkNon() {
    }
	...
	public static int getQcount(String id_exam) throws QmTmException
    {
        ...
        try {
            ...
            throw new QmTmException("시험 문제수 읽어오는중 오류가 발생되었습니다. [PracticeMarkNon.getQcount] " + ex.getMessage());
        } finally {
	...
	public static PracticeMarkNonBean[] getBean(String id_exam, String id_q) throws QmTmException 
	{
        Connection cnn = null; PreparedStatement stm = null; ResultSet rst = null;
	    ...
	    try {
            ...
            if (bean == null) {
                ...
                return (PracticeMarkNonBean[]) beans.toArray(new PracticeMarkNonBean[0]);
            }
		} catch (SQLException ex) {
			throw new QmTmException("시험지 문제 정보 읽어오는중 오류가 발생되었습니다. [PracticeMarkNon.getBean] " + ex.getMessage());
		} finally { 
			if (rst != null) try { rst.close(); } catch (SQLException ex) {}
			if (stm != null) try { stm.close(); } catch (SQLException ex) {}
			if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	private static PracticeMarkNonBean makeBean (ResultSet rst) throws QmTmException
    {
		try {
            PracticeMarkNonBean bean = new PracticeMarkNonBean();
            bean.setNr_set(rst.getInt(1));
			bean.setNr_q(rst.getInt(2));
			bean.setAllotting(rst.getDouble(3));
            return bean;
        } catch (SQLException ex) {
            throw new QmTmException("시험지 문제 정보 읽어오는중 오류가 발생되었습니다. [PracticeMarkNon.makeBean] " + ex.getMessage());
        }
    }

	public static PracticeMarkNonBean[] getBeans(String id_exam, String nr_sets) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("응시자 답안지 정보 읽어오는중 오류가 발생되었습니다. [PracticeMarkNon.getBeans] " + ex.getMessage());
        }
        finally {
            if (rst != null) try { rst.close(); } catch (SQLException ex) {}
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
	...
	private static PracticeMarkNonBean makeBeans (ResultSet rst) throws QmTmException
    {
		try {
            PracticeMarkNonBean bean = new PracticeMarkNonBean();
            ...
            throw new QmTmException("응시자 답안지 정보 읽어오는중 오류가 발생되었습니다. [PracticeMarkNon.makeBeans] " + ex.getMessage());
        }
    }

	public static PracticeMarkNonBean getBean2(String id_q) throws QmTmException 
	{
        Connection cnn = null; PreparedStatement stm = null; ResultSet rst = null;
		StringBuffer sql = new StringBuffer();
	    ...
	    try {
			...
			throw new QmTmException("시험 문제정보 읽어오는중 오류가 발생되었습니다. [PracticeMarkNon.getBean2] " + ex.getMessage());
		} finally { 
			if (rst != null) try { rst.close(); } catch (SQLException ex) {}
			if (stm != null) try { stm.close(); } catch (SQLException ex) {}
			if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	private static PracticeMarkNonBean makeBean2 (ResultSet rst) throws QmTmException
    {
		try {
            PracticeMarkNonBean bean = new PracticeMarkNonBean();
            ...
            throw new QmTmException("시험 문제정보 읽어오는중 오류가 발생되었습니다. [PracticeMarkNon.makeBean2] " + ex.getMessage());
        }
    }

	public static PracticeMarkNonBean getBeans3(String id_q, String id_exam) throws QmTmException 
	{
        Connection cnn = null; PreparedStatement stm = null; ResultSet rst = null;
		StringBuffer sql = new StringBuffer();
	    ...
	    try {
			...
			throw new QmTmException("시험 문제정보 읽어오는중 오류가 발생되었습니다. [PracticeMarkNon.getBeans3] " + ex.getMessage());
		} finally { 
			if (rst != null) try { rst.close(); } catch (SQLException ex) {}
			if (stm != null) try { stm.close(); } catch (SQLException ex) {}
			if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	private static PracticeMarkNonBean makeBeans3 (ResultSet rst) throws QmTmException
    {
		try {
            PracticeMarkNonBean bean = new PracticeMarkNonBean();
            bean.setQ(rst.getString(1));
            ...
            throw new QmTmException("시험 문제정보 읽어오는중 오류가 발생되었습니다. [PracticeMarkNon.makeBeans3] " + ex.getMessage());
        }
    }

	public static PracticeMarkNonBean getAnswer(String id_q, String userid, String id_exam) throws QmTmException 
	{
        Connection cnn = null; PreparedStatement stm = null; ResultSet rst = null;
		StringBuffer sql = new StringBuffer();
	    ...
	    try {
			...
			throw new QmTmException("응시자 논술형 답안지 정보 읽어오는중 오류가 발생되었습니다. [PracticeMarkNon.getAnswer] " + ex.getMessage());
		} finally { 
			if (rst != null) try { rst.close(); } catch (SQLException ex) {}
			if (stm != null) try { stm.close(); } catch (SQLException ex) {}
			if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	private static PracticeMarkNonBean makeAnswer (ResultSet rst) throws QmTmException
    {
		try {
            PracticeMarkNonBean bean = new PracticeMarkNonBean();
            ...
            throw new QmTmException("응시자 논술형 답안지 정보 읽어오는중 오류가 발생되었습니다. [PracticeMarkNon.makeAnswer] " + ex.getMessage());
        }
    }

	public static PracticeMarkNonBean getBean3(String id_q, String userid, String id_exam) throws QmTmException 
	{
        Connection cnn = null; PreparedStatement stm = null; ResultSet rst = null;
		StringBuffer sql = new StringBuffer();
	    ...
	    try {
			...
			throw new QmTmException("응시자 답안지 정보 읽어오는중 오류가 발생되었습니다. [PracticeMarkNon.getBean3] " + ex.getMessage());
		} finally { 
			if (rst != null) try { rst.close(); } catch (SQLException ex) {}
			if (stm != null) try { stm.close(); } catch (SQLException ex) {}
			if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	private static PracticeMarkNonBean makeBean3 (ResultSet rst) throws QmTmException
    {
		try {
            PracticeMarkNonBean bean = new PracticeMarkNonBean();
            ...
            throw new QmTmException("응시자 답안지 정보 읽어오는중 오류가 발생되었습니다. [PracticeMarkNon.makeBean3] " + ex.getMessage());
        }
    }

	public static void updateNon(String id_exam, String id_q, String userid, PracticeMarkNonBean bean) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("응시자 답안지 정보 변경하는중 오류가 발생되었습니다. [PracticeMarkNon.updateNon] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void updateComments(String id_exam, String id_q, String userid, PracticeMarkNonBean bean) throws QmTmException
    {
        Connection cnn = null; PreparedStatement stm = null; 
		StringBuffer sql = new StringBuffer();
        ...
        try
        {
            ...
            throw new QmTmException("응시자 답안 강평 입력하는중 오류가 발생되었습니다. [PracticeMarkNon.updateComments] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static int userNonCnt(String id_exam, String id_q, String userid) throws QmTmException
    {
		...
		try
		{
            ...
            throw new QmTmException("임시테이블에 응시자 답안 읽어오는중 오류가 발생되었습니다. [PracticeMarkNon.userNonCnt] " + ex.getMessage());
		}
		finally {
			if (rst != null) try { rst.close(); } catch (SQLException ex) {}
			if (stm != null) try { stm.close(); } catch (SQLException ex) {}
	...
	public static void userNonInsert(String id_exam, String id_q, String userid) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("임시테이블에 응시자 답안 입력하는중 오류가 발생되었습니다. [PracticeMarkNon.userNonInsert] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void userNonUpdate(String id_exam, String id_q, String userid, double score) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("임시테이블에 응시자 답안 수정하는중 오류가 발생되었습니다. [PracticeMarkNon.userNonUpdate] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
