...
public class AnswerMarkDan
{
	...
	public static AnswerMarkDanBean[] getBeans(String id_exam, long id_q) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("응시자 답안지 정보 읽어오는 중 오류가 발생되었습니다. [AnswerMarkDan.getBeans] " + ex.getMessage());
        }
        finally {
    ...
    private static AnswerMarkDanBean makeBeans (ResultSet rst) throws QmTmException
    {
		try {
            ...
            throw new QmTmException("응시자 답안지 정보 읽어오는 중 오류가 발생되었습니다. [AnswerMarkDan.makeBeans] " + ex.getMessage());
        }
    }
	...
	public static AnswerMarkDanBean getBean(String id_exam, String userid, long id_q) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("응시자 답안지 정보 읽어오는 중 오류가 발생되었습니다. [AnswerMarkDan.getBean] " + ex.getMessage());
        } finally {
            if (rst != null) try { rst.close(); } catch (SQLException ex) {}
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
    ...
    private static AnswerMarkDanBean makeBean (ResultSet rst) throws QmTmException
    {
		try {
            ...
            throw new QmTmException("응시자 답안지 정보 읽어오는 중 오류가 발생되었습니다. [AnswerMarkDan.makeBean] " + ex.getMessage());
        }
    }
	...
	public static void update(String id_exam, String userid, String oxs, String points, double score) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("응시자 답안지 정보 수정하는 중 오류가 발생되었습니다. [AnswerMarkDan.update] " + ex.getMessage());
		} finally {
			if (stm != null)	try {	stm.close();	} catch (SQLException ex) {}
			if (cnn != null)	try {	cnn.close();	} catch (SQLException ex) {}
		}
