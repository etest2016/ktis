...
public class PersonalTime
{
	...
	public static PersonalTimeBean getBean(String id_exam, String userid) throws QmTmException 
	{
	    ...
	    try {
			...
			throw new QmTmException("응시자 답안 정보 읽어오는 중 오류가 발생되었습니다. [PersonalTime.getBean] " + ex.getMessage());
		} finally { 
	...
	private static PersonalTimeBean makeBean (ResultSet rst) throws QmTmException
    {
		try {
            ...
            throw new QmTmException("응시자 답안지 정보 읽어오는 중 오류가 발생되었습니다. [PersonalTime.makeBean] " + ex.getMessage());
        }
    }
	...
	public static PersonalTimeBean getTime(String id_exam, String userid) throws QmTmException 
	{
	    ...
	    try {
			...
			throw new QmTmException("개인시간 정보 읽어오는 중 오류가 발생되었습니다. [PersonalTime.getTime] " + ex.getMessage());	
		} finally { 
			if (rst != null) try { rst.close(); } catch (SQLException ex) {}
			if (stm != null) try { stm.close(); } catch (SQLException ex) {}
			if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static PersonalTimeBean getTime2(String id_exam) throws QmTmException 
	{
	    ...
	    try {
			...
			throw new QmTmException("시험시간 정보 읽어오는 중 오류가 발생되었습니다. [PersonalTime.getTime2] " + ex.getMessage());			
		} finally { 
			if (rst != null) try { rst.close(); } catch (SQLException ex) {}
			if (stm != null) try { stm.close(); } catch (SQLException ex) {}
			if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	private static PersonalTimeBean makeTime(ResultSet rst) throws QmTmException
    {
		try {
            ...
            throw new QmTmException("시간 정보 읽어오는 중 오류가 발생되었습니다. [PersonalTime.makeTime] " + ex.getMessage());
        }
    }
	...
	public static long getLimittime(String id_exam) throws QmTmException
	{
		...
		try {
            ...
            throw new QmTmException("시험 제한시간 정보 읽어오는 중 오류가 발생되었습니다. [PersonalTime.getLimittime] " + ex.getMessage());
        } finally {
            if (rst != null) try { rst.close(); } catch (SQLException ex) {}
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static PersonalTimeBean[] getUserTimeList(String id_exam) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("개인별 변경시간정보 읽어오는 중 오류가 발생되었습니다. [PersonalTime.getUserTimeList] " + ex.getMessage());
        }
        finally {
            if (rst != null) try { rst.close(); } catch (SQLException ex) {}
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
    ...
    private static PersonalTimeBean makeUserTime (ResultSet rst) throws QmTmException
    {
		try {
            ...
            throw new QmTmException("개인별 변경시간정보 읽어오는 중 오류가 발생되었습니다. [PersonalTime.makeUserTime] " + ex.getMessage());
        }
    }
