...
public class QUtil
{
	...
	public static void insert(QBean bean) throws QmTmException
    {
		...
		sql.append("              find_kwd, userid, id_q_use, ex_rowcnt, yn_single_line ) "); 
        sql.append("VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ");
		sql.append("        ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ");
		sql.append("        ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ");
		sql.append("        ?, ?, ?, ?, ? ) ");
        ...
        try
        {
            ...
            throw new QmTmException("문제 등록하는 중 오류가 발생되었습니다. [QUtil.insert] " +ex.getMessage());			
        }
        finally {
	...
	public static void update(String id_q, QBean bean) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("문제 정보 수정하는 중 오류가 발생되었습니다. [QUtil.update] " +ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void insert_text(QBean bean) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("문제 등록하는 중 오류가 발생되었습니다. [QUtil.insert_text] " +ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void insertRef(QRefBean bean) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("지문문제 등록하는 중 오류가 발생되었습니다. [QUtil.insertRef] " +ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void updateRef(String id_ref, QRefBean bean) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("지문문제 정보 수정하는 중 오류가 발생되었습니다. [QUtil.updateRef] " +ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void insertMsg(int seq, String front_msg, String back_msg, String box_size) throws QmTmException
    {
        ...
        sql.append("Select max(id_q), ?, ?, ?, ? From q ");
        ...
        try
        {
			...
			stm = cnn.prepareStatement(sql.toString());
			stm.setInt(1, seq);
			stm.setString(2, front_msg);
			stm.setString(3, back_msg);
			stm.setString(4, box_size);
			stm.executeUpdate();
        }
        catch (SQLException ex) {
            throw new QmTmException("단답형 답안 입력박스 등록하는 중 오류가 발생되었습니다. [QUtil.insertMsg] " +ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void insertMsg2(String id_q, int seq, String front_msg, String back_msg, String box_size) throws QmTmException
    {
        ...
        try
        {
			...
			stm.setInt(2, seq);
			stm.setString(3, front_msg);
			stm.setString(4, back_msg);
			stm.setString(5, box_size);
			
			stm.executeUpdate();
        }
        catch (SQLException ex) {
            throw new QmTmException("단답형 답안 입력박스 등록하는 중 오류가 발생되었습니다. [QUtil.insertMsg2] " +ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void updateMsg(String id_q, int seq, String front_msg, String back_msg, String box_size) throws QmTmException
    {
		...
		sql.append("       Set front_msg = ?, back_msg = ?, box_size = ? ");
		sql.append("Where id_q = ? and seq = ? ");

        try
        {
            cnn = DBPool.getConnection();
			stm = cnn.prepareStatement(sql.toString());
			stm.setString(1, front_msg);
			stm.setString(2, back_msg);
			stm.setString(3, box_size);
			stm.setString(4, id_q);
			stm.setInt(5, seq);
			stm.executeUpdate();
        }
        catch (SQLException ex) {
            throw new QmTmException("단답형 답안 입력박스 수정하는 중 오류가 발생되었습니다. [QUtil.updateMsg] " +ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static QBean getBean(String id_q) throws QmTmException 
	{
		...
		sql.append("       b.id_valid_type, b.id_q_use, b.q_use_detail, b.ex_rowcnt, b.yn_single_line, ");
		sql.append("       c.reftitle, c.refbody1, c.refbody2, c.refbody3, a.make_cnt ");
		...
		try
		{
			...
			throw new QmTmException("문제 정보 읽어오는 중 오류가 발생되었습니다. [QUtil.getBean] " +ex.getMessage());
		} 
		finally {
	...
	public static QBean getBeans2(String id_q, String id_subject, String id_chapter) throws QmTmException 
	{
		Connection cnn = null; PreparedStatement stm = null; ResultSet rst = null;
		StringBuffer sql = new StringBuffer();
		...
		sql.append("       c.reftitle, c.refbody1, c.refbody2, c.refbody3, a.make_cnt ");
		sql.append("From make_q as a inner join q as b ");
		sql.append("     on b.id_q = ? and b.id_subject = ? and b.id_chapter = ? and a.id_q = b.id_q ");
		sql.append("     left outer join q_ref as c on b.id_ref = c.id_ref ");
		...
		try
		{
			...
			throw new QmTmException("문제 정보 읽어오는 중 오류가 발생되었습니다. [QUtil.getBeans2] " +ex.getMessage());
		} 
		finally {
			if (rst != null) try { rst.close(); } catch (SQLException ex) {}
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
	...
	private static QBean makeBean (ResultSet rst) throws QmTmException
    {
		try {
            ...
            throw new QmTmException("문제 정보 읽어오는 중 오류가 발생되었습니다. [QUtil.makeBean] " +ex.getMessage());
        }
    }

	public static QBean[] getEditBean(String id_subject, String id_chapter) throws QmTmException
    {
        Connection cnn = null; PreparedStatement stm = null; ResultSet rst = null; 
		StringBuffer sql = new StringBuffer();
		...
		sql.append("From q ");
		sql.append("Where id_subject = ? and id_chapter = ? ");
		sql.append("Order by id_q ");
        ...
        try
        {
            ...
            QBean bean = null;
            while (rst.next()) {
                bean = makeEditBean(rst);
                beans.add(bean);
            }
            if (bean == null) {
                return null;
            } else {
                return (QBean[]) beans.toArray(new QBean[0]);
            }
        }
        catch (SQLException ex) {
            throw new QmTmException("변경할 문제 코드 정보 읽어오는 중 오류가 발생되었습니다. [QUtil.getEditBean] " +ex.getMessage());
        }
        finally {
            if (rst != null) try { rst.close(); } catch (SQLException ex) {}
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
	...
	private static QBean makeEditBean (ResultSet rst) throws QmTmException
    {
		...
		try {
            ...
            throw new QmTmException("변경할 문제 코드 정보 읽어오는 중 오류가 발생되었습니다. [QUtil.makeEditBean] " +ex.getMessage());
        }
    }
	...
	public static QMsgBean[] getMsgBeans(String id_q) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("단답형 답안 입력박스 정보 읽어오는 중 오류가 발생되었습니다. [QUtil.getMsgBeans] " +ex.getMessage());
        }
        finally {
            if (rst != null) try { rst.close(); } catch (SQLException ex) {}
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
    ...
    private static QMsgBean makeBeans (ResultSet rst) throws QmTmException
    {
		...
		try {
            ...
            throw new QmTmException("단답형 답안 입력박스 정보 읽어오는 중 오류가 발생되었습니다. [QUtil.makeBeans] " +ex.getMessage());
        }
    }
	...
	public static void updateIncorrect(String id_q, int id_valid_type) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("오류문제 처리작업 중 오류가 발생되었습니다. [QUtil.updateIncorrect] " +ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void makecntAdd() throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("문제 출제횟수 등록하는 중 오류가 발생되었습니다. [QUtil.makecntAdd] " +ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static QRefBean[] getBeans(String id_subject) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("지문형 문제정보 읽어오는 중 오류가 발생되었습니다. [QUtil.getBeans] " +ex.getMessage());
        }
        finally {
            if (rst != null) try { rst.close(); } catch (SQLException ex) {}
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
	...
	private static QRefBean makeRefBeans (ResultSet rst) throws QmTmException
    {
		...
		try {
            ...
            throw new QmTmException("지문형 문제정보 읽어오는 중 오류가 발생되었습니다. [QUtil.makeRefBeans] " +ex.getMessage());
        }
    }
}