...
public class ManagerQUtil
{
	...
	public static int getBeanCnt(String userid) throws QmTmException
    {
        ...
        try
        {
			...
			throw new QmTmException("문제관리 권한 정보를 읽어오는 중 오류가 발생되었습니다. [ManagerQUtil.getBeanCnt] " + ex.getMessage());
        }
        finally {
	...
	public static ManagerQBean[] getBeans(String userid) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("교수자 문제관리 권한정보를 읽어오는 중 오류가 발생되었습니다. [ManagerQUtil.getBeans] " + ex.getMessage());
        }
        finally {
            if (rst != null) try { rst.close(); } catch (SQLException ex) {}
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
    ...
    private static ManagerQBean makeBeans (ResultSet rst) throws QmTmException
    {
		try {
            ...
            throw new QmTmException("교수자 문제관리 권한정보를 읽어오는 중 오류가 발생되었습니다. [ManagerQUtil.makeBeans] " + ex.getMessage());
        }
    }
	...
	public static ManagerQBean[] getAddBeans(String userid) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("문제관리 과목정보를 읽어오는 중 오류가 발생되었습니다. [ManagerQUtil.getAddBeans] " + ex.getMessage());
        }
        finally {
            if (rst != null) try { rst.close(); } catch (SQLException ex) {}
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
	...
	private static ManagerQBean makeAddBeans (ResultSet rst) throws QmTmException
    {
		try {
            ...
            throw new QmTmException("문제관리 과목정보를 읽어오는 중 오류가 발생되었습니다. [ManagerQUtil.makeAddBeans] " + ex.getMessage());
        }
    }
	...
	public static void insert(String userid, String id_subject, String q_edit, String q_del) throws QmTmException
    {
        ...
        try
        {
            ...
            stm = cnn.prepareStatement(sql.toString());
            stm.setString(1, userid);
            stm.setString(2, q_edit);
            stm.setString(3, q_del);
            stm.setString(4, id_subject);
            stm.executeUpdate();

        }
        catch (SQLException ex) {
            throw new QmTmException("교수자 문제관리 권한정보를 등록하는 중 오류가 발생되었습니다. [ManagerQUtil.insert] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static ManagerQBean getBean(String userid, String id_subject) throws QmTmException 
	{
		...
		sql.append("Select top 1 a.id_subject, b.q_subject, a.pt_q_edit, a.pt_q_delete, convert(varchar(16), a.regdate, 120) regdate ");
		sql.append("From q_worker_subj a, q_subject b ");
	    ...
	    try {
			...
			throw new QmTmException("교수자 문제관리 권한정보를 읽어오는 중 오류가 발생되었습니다. [ManagerQUtil.getBean] " + ex.getMessage());
		} finally { 
			if (rst != null) try { rst.close(); } catch (SQLException ex) {}
			if (stm != null) try { stm.close(); } catch (SQLException ex) {}
			if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void update(String userid, String id_subject, String q_edit, String q_del) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("교수자 문제관리 권한정보를 수정하는 중 오류가 발생되었습니다. [ManagerQUtil.update] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void delete(String userid, String id_subject) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("교수자 문제관리 권한정보를 삭제하는 중 오류가 발생되었습니다. [ManagerQUtil.delete] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
