...
public class ManagerSubjUtil
{
	...
	public static ManagerSubjBean[] getBeans(String userid) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("담당자 권한정보를 읽어오는 중 오류가 발생되었습니다. [ManagerSubjUtil.getBeans] " + ex.getMessage());
        }
        finally {
    ...
    private static ManagerSubjBean makeBeans (ResultSet rst) throws QmTmException
    {
		try {
            ...
            throw new QmTmException("담당자 권한정보를 읽어오는 중 오류가 발생되었습니다. [ManagerSubjUtil.makeBeans] " + ex.getMessage());
        }
    }	
	...
	public static ManagerSubjBean getBean(String userid, String id_course) throws QmTmException 
	{
	    ...
	    try {
			...
			throw new QmTmException("담당자 권한정보를 읽어오는 중 오류가 발생되었습니다. [ManagerSubjUtil.getBean] " + ex.getMessage());
		} finally { 
			if (rst != null) try { rst.close(); } catch (SQLException ex) {}
			if (stm != null) try { stm.close(); } catch (SQLException ex) {}
			if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static ManagerQBean getQBean(String userid, String id_course) throws QmTmException 
	{
	    ...
	    try {
			...
			throw new QmTmException("담당자 문제은행 권한정보를 읽어오는 중 오류가 발생되었습니다. [ManagerQBean.getQBean] " + ex.getMessage());
		} finally { 
			if (rst != null) try { rst.close(); } catch (SQLException ex) {}
			if (stm != null) try { stm.close(); } catch (SQLException ex) {}
			if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	private static ManagerQBean makeQBeans (ResultSet rst) throws QmTmException
    {
		try {
            ...
            throw new QmTmException("담당자 문제은행 권한정보를 읽어오는 중 오류가 발생되었습니다. [ManagerSubjUtil.makeQBeans] " + ex.getMessage());
        }
	}
