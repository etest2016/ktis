...
public class QuseUtil
{
	...
	public static void insert(QuseBean bean) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("문제용도 정보 등록하는 중 오류가 발생되었습니다. [QuseUtil.insert] " + ex.getMessage());
        }
        finally {
	...
	public static void update(QuseBean bean) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("문제용도 정보 수정하는 중 오류가 발생되었습니다. [QuseUtil.update] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void delete(String id_q_use) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("문제용도 정보 삭제하는 중 오류가 발생되었습니다. [QuseUtil.delete] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static QuseBean[] getBeans() throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("문제용도 정보 읽어오는 중 오류가 발생되었습니다. [QuseUtil.getBeans] " + ex.getMessage());
        }
        finally {
    ...
    private static QuseBean makeBeans (ResultSet rst) throws QmTmException
    {
		...
		try {
            ...
            throw new QmTmException("문제용도 정보 읽어오는 중 오류가 발생되었습니다. [QuseUtil.makeBeans] " + ex.getMessage());
        }
    }
	...
	public static QuseBean getBean(String id_q_use) throws QmTmException 
	{
	    ...
	    try {
			...
			throw new QmTmException("문제용도 정보 읽어오는 중 오류가 발생되었습니다. [QuseUtil.getBean] " + ex.getMessage());
		} finally { 
			if (rst != null) try { rst.close(); } catch (SQLException ex) {}
			if (stm != null) try { stm.close(); } catch (SQLException ex) {}
			if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	private static QuseBean makeBean (ResultSet rst) throws QmTmException
    {
		...
		try {
            ...
            throw new QmTmException("문제용도 정보 읽어오는 중 오류가 발생되었습니다. [QuseUtil.makeBean] " + ex.getMessage());
        }
    }
}