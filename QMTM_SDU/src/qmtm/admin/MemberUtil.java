...
public class MemberUtil
{
	...
	public static MemberBean[] getBeans(int list_cnt, int lists, String field, String str) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("접수 인원 정보 읽어오는 중 오류가 발생되었습니다. [MemberUtil.getBeans] " + ex.getMessage());
        }
        finally {
	...
	public static MemberBean[] getAllBeans(String field, String str) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("접수 인원 정보 읽어오는 중 오류가 발생되었습니다. [MemberUtil.getAllBeans] " + ex.getMessage());
        }
        finally {
            if (rst != null) try { rst.close(); } catch (SQLException ex) {}
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
    ...
    private static MemberBean makeBeans (ResultSet rst) throws QmTmException
    {
		...
		try {
            ...
            throw new QmTmException("접수 인원 정보 읽어오는 중 오류가 발생되었습니다. [MemberUtil.makeBeans] " + ex.getMessage());
        }
    }
	...
	public static void deleteMember(String id_exam, String userid) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("대상자정보 삭제 중 오류가 발생되었습니다. [MemberUtil.deleteMember] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void getMCnt(String userid, MemberBean rb) throws QmTmException
	{
		...
		try {
            ...
            throw new QmTmException("회원 정보 읽어오는 중 오류가 발생되었습니다. [MemberUtil.getMCnt] " + ex.getMessage());
        } finally {
            if (rst != null) try { rst.close(); } catch (SQLException ex) {}
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void insertMember(String userid, MemberBean bean) throws QmTmException
    {
		...
		try
        {
            ...
            throw new QmTmException("회원정보 등록 중 오류가 발생되었습니다. [MemberUtil.insertMember] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static void updateMember(String userid, MemberBean bean) throws QmTmException
    {
        ...
        try
        {
            ...
            throw new QmTmException("회원정보 수정 중 오류가 발생되었습니다. [MemberUtil.updateMember] " + ex.getMessage());
        }
        finally {
            if (stm != null) try { stm.close(); } catch (SQLException ex) {}
            if (cnn != null) try { cnn.close(); } catch (SQLException ex) {}
	...
	public static int getCounts(String field, String str) throws QmTmException {
		...
		try {
			...
			throw new QmTmException("대상자 정보 읽어오는 중 오류가 발생되었습니다. [MemberUtil.getCounts] " + ex.getMessage());
		} finally {
			if (rst != null)    try {   rst.close();    } catch (SQLException ex) {}
			if (stm != null)	try {	stm.close();	} catch (SQLException ex) {}
			if (cnn != null)	try {	cnn.close();	} catch (SQLException ex) {}
