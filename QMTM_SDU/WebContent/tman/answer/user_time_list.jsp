...
//   모 듈 명 : 개인시간 변경 리스트
//   설    명 : 개인시간 변경 리스트
//   테 이 블 : personal_time, qt_userid
//   자바파일 : qmtm.ComLib, qmtm.tman.answer.PersonalTimeBean, qmtm.tman.answer.PersonalTime
//   작 성 일 : 2013-02-15
//   작 성 자 : 이테스트 석준호
//   수 정 일 : 
//   수 정 자 : 
...
<%@ page import="qmtm.ComLib, qmtm.tman.answer.PersonalTimeBean, qmtm.tman.answer.PersonalTime" %>
...
<BODY id="popup2">
	...
	<div id="top">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<Td id="left"></td>
				<Td id="mid"><div class="title">개인시간변경 리스트</div></td>
				<Td id="right"></td>
			</tr>
		</table>
	</div>
	<div id="contents">
		...
		<table border="0" cellpadding ="0" cellspacing="0" id="tableA" width="100%" style="margin-bottom: 0px;">
			<tr id="tr" align=center>
				...
				<td width=10%>아이디</td>
				<td width=10%>성명</td>
				<td width=15%>시험입장시간</td>
				<td width=15%>입장종료시간</td>
				<td width=15%>시험시작시간</td>
				<td width=15%>시험종료시간</td>
				<td width=15%>변경시간</td>
			</tr>
		</table>
		...
		<div style="overflow: auto; width:100%; height:260px; margin-top: 0px;">
			...
			<table border="0" cellpadding ="0" cellspacing="0" id="tableA" width="100%">
				...
				%>
				<tr>
					<td class="blank" colspan="7">개인시간 변경 리스트가 없습니다.</td>
				</tr>
				<%
					} else { 
