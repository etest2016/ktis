...
<body id="popup2">
	...
	<div id="top">
		<table border="0" cellpadding="0" cellspacing="0" width="98%">
			<tr>
				<Td id="left"></td>
				<Td id="mid"><div class="title">문제별 응시자 채점</div></td>
				<Td id="right"></td>
			</tr>
		</table>
	</div>
	<div id="contents">
		...
		<table border="0" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC"  width="580">
			<tr bgcolor="#FFFFFF">
				<td height="40" valign="middle">&nbsp;<b><%=bean.getQ()%></b> <BR><b>(문제코드 : <%=bean.getId_q()%>, 배점 : <%=bean.getAllotting()%>)</b></td>
			</tr>
		</table>
