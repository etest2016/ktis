...
<%@ page import="qmtm.*, qmtm.common.*, qmtm.tman.exam.*, qmtm.tman.paper.*, java.sql.*, java.util.*" %>
...
<%	
	...
	bigos.append("시험지수 : ");
	bigos.append(paper_cnts);
	bigos.append(", 화면당문제수 : ");
	bigos.append(String.valueOf(qcntperpage));
	bigos.append(", 출제유형 : ");
	if(randomtypes2.equals("NN")) { 
		bigos.append("섞지않음");
	} else if(randomtypes2.equals("NQ")) { 
		bigos.append("문제섞기");
	} else if(randomtypes2.equals("NT")) { 
		bigos.append("문제 및 보기섞기");
	} else if(randomtypes2.equals("YQ")) { 
		bigos.append("문제추출=>문제섞기");
	} else if(randomtypes2.equals("YT")) { 
