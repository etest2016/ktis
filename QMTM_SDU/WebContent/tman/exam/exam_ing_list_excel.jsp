	...
	<title></title>
		...
		<table border="1" cellpadding="0" cellspacing="0" >
			<tr align="center" height="30" >
				<td bgcolor="#9DBFFF">과정명</td>
				<td bgcolor="#9DBFFF">시험명</td>
				<td bgcolor="#9DBFFF">시험시작일</td>
				<td bgcolor="#9DBFFF">시험종료일</td>
				<td bgcolor="#9DBFFF">대상인원</td>
				<td bgcolor="#9DBFFF">응시인원</td>
				<td bgcolor="#9DBFFF">미응시인원</td>		
			</tr>
<% if(rst == null) {%>
			<tr height="40">
