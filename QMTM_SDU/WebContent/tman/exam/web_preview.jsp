...
<!--
	...
	{
		window.open("<%=ComLib.getConfig("weburl")%>/paper/fraTest.jsp?id_exam=<%= id_exam %>&userid=tman@@2008", "test_exampaper", "fullscreen=yes, scrollbars=yes");
	}
...
<BODY id="popup2">   
   ...
   <div id="top">
	...
	<div id="button">
		<a href="javascript:frameofTest();" onfocus="this.blur();"><img src="../../images/bt_paper_preview_yj1.gif"></a>&nbsp;&nbsp;<img src="../../images/bt5_exit_yj1_11.gif" onclick="window.close();" style="cursor: pointer;">
	</div>
