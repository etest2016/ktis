...
<BODY id="popup2">
	...
	<div id="top">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<Td id="left"></td>
				<Td id="mid"><div class="title">평가결과 다운로드<span>선택한 시험에 응시결과, 문제별 분석결과를 다운로드할 수 있습니다.</span></div></td>
				<Td id="right"></td>
			</tr>
		</table>
	</div>
...
%>
	...
	<div id="button">
		<input type="button" value="응시결과엑셀다운" class="form" onClick="ans_excel();">&nbsp;&nbsp;<input type="button" value="문제분석엑셀다운" class="form" onClick="q_excel();">&nbsp;&nbsp;<input type="button" value="창닫기" class="form" onClick="window.close();">
	</div>
