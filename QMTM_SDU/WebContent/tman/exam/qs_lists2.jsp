...
<table cellpadding='0' cellspacing='1' border=0 bgcolor="#CCCCCC" width="100%" align="center">
	<tr bgcolor="#e6e6e6" height="30">
		...
		<td align="center" width="15%"><b>문제유형</b></td>
		<td align="center" width="10%"><b>문제수</b></td>
		<td align="center" width="10%"><b>정렬순서</b></td>
		<td align="center" width="10%"><b>문제추출</b></td>
		<td align="center" width="10%"><b>추출문제수</b></td>
		<td align="center" width="10%"><b>문제배점</b></td>
	</tr>
<%
...
%>
	<tr bgcolor="#FFFFFF" height="25">
		...
		<td align="center"><input type="button" value="문제추출" onClick="q_extract('<%=i%>', '<%=qs_list[i].getCnts()%>', '<%=qs_list.length%>', '<%=ref_cnt_res%>')"></td>
...
%>
		...
		<input type="hidden" name="ref_qs<%=i%>" size="3" value="0" >
		<input type="hidden" name="ref_score<%=i%>" size="3" value="0" >
<%
			ii++;
		}
	} else {
...
<table cellpadding='0' cellspacing='1' border=0 bgcolor="#CCCCCC" width="100%" align="center">
	<tr bgcolor="#e6e6e6" height="30">
		...
		<td align="center" width="10%">문제추출</td>
		<td align="center" width="10%">추출문제수</td>
		<td align="center" width="10%">문제배점</td>
	</tr>
<%
	for(int i=0; i<qs_list.length; i++) {
%>
