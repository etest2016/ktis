		...
		<div style="display:none;" id="id_scores">
			...
			<table border="0" width="100%" cellpadding ="0" cellspacing="0" id="tableD">
				...
				<tr>
					...
					<td><input type="checkbox" name="yn_stat" value="Y" <% if(exams.getYn_stat().equals("Y")) { %> checked <% } %>>응시자에게 성적통계 제공</td>
				</tr>				
			</table>
			...
			<table border="0" width="100%" cellpadding ="0" cellspacing="0" id="tableD">
				<tr>
					...
					<td style="padding-left: 20px;">
						<input type="radio" name="paper_type" value="11" <%if(exams.getPaper_type() == 11) { %> checked <% } %> onClick="paper_change(this.value);">&nbsp;시험지디자인 1<br>
						<input type="radio" name="paper_type" value="12" <%if(exams.getPaper_type() == 12) { %> checked <% } %> onClick="paper_change(this.value);">&nbsp;시험지디자인 2<br>
						<input type="radio" name="paper_type" value="13" <%if(exams.getPaper_type() == 13) { %> checked <% } %> onClick="paper_change(this.value);">&nbsp;시험지디자인 3<br>
						<input type="radio" name="paper_type" value="21" <%if(exams.getPaper_type() == 21) { %> checked <% } %> onClick="paper_change(this.value);">&nbsp;시험지디자인 4<br>
						<input type="radio" name="paper_type" value="22" <%if(exams.getPaper_type() == 22) { %> checked <% } %> onClick="paper_change(this.value);">&nbsp;시험지디자인 5<br>
						<input type="radio" name="paper_type" value="23" <%if(exams.getPaper_type() == 23) { %> checked <% } %> onClick="paper_change(this.value);">&nbsp;시험지디자인 6<br>
					</td>
