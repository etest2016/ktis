...
<HTML>
 ...
 <script language="JavaScript" type="text/javascript">
	...
	function guide_write() {
		$.posterPopup("paper_guide_write.jsp?id_exam=<%=id_exam%>","guide_write","width=350, height=260, scrollbars=no");
	}

	function guide_view(nr_q) {
		$.posterPopup("paper_guide_view.jsp?id_exam=<%=id_exam%>&nr_q="+nr_q,"guide_view","width=350, height=260, scrollbars=no");
	}
