...
<%
	...
	String exam_pwd_str = request.getParameter("exam_pwd_str");
	...
	bean.setId_ltimetype(id_ltimetype);
...
<script language="javascript">	
	...
	alert("정상적으로 시험이 생성되었습니다.");	
	opener.parent.fraMain.location.reload(); 
	<% if(id_auth_type == 2) { %>
	location.href="exam_edit.jsp?id_exam=<%=id_exam%>";
	<% } else { %>
	window.close();
	<% } %>
</script>