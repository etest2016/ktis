...
<script language="JavaScript">
	function extract_send() {
		...
		if(Number(frm.qCnt.value) > qCnt) {
			alert("추출가능한 문제수보다 큰 문제수를 입력하셨습니다. \n\n추출가능한 문제수를 확인하시고 다시 입력해주세요.");
			return;
		}
...
<BODY id="popup2">
	...
	<div id="top">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<Td id="left"></td>
				<Td id="mid"><div class="title">문제 추출 </div></td>
				<Td id="right"></td>
			</tr>
		</table>
	</div>
	...
	<table border="0" cellpadding ="0" cellspacing="0" id="tableD">
			<tr>
				<td width="65%" id="left">추출 문제수&nbsp;(총 문제수 : <b><%=qCnt%></b>)&nbsp;</td>
				<td >&nbsp;&nbsp;<input type="text" class="input" name="qCnt" size="4"> 문제</td>
			</tr>
			<tr>
				<td width="65%" id="left">배점&nbsp;(추출문제별 배점)&nbsp;</td>
	...
	<div id="button">
		<img src="../../images/bt_exam_list_yj1.gif" onfocus="this.blur();" onClick="extract_send();" style="cursor:pointer">&nbsp;
		<img onclick="window.close();" src="../../images/bt5_exit_yj1.gif" onfocus="this.blur();" style="cursor:pointer">
	</div>
