...
top.fraTest.document.all.ex11.innerHTML = tmp2;
top.fraTest.document.frmData.nonans.value = RestoreChar2(Cnv("<%= ans %>"));
top.fraTest.document.frmData.oldnon.value = RestoreChar2(Cnv("<%= ans %>"));
top.fraTest.ButtonVisible();
