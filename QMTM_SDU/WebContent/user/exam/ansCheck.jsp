...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
	<tr>
		<% if (yn_end == null) { %>
        <td align="center"><img src="../images/submitm.gif" border="0" onclick="window.close();" style="cursor: pointer;"></td>
	    <% } else if (yn_end.equals("Y")) { %>
        <td align="center"><img src="../images/submito.gif" border="0" onclick="window.close();" style="cursor: pointer;"></td>
		<% } else { %><!-- N etc -->
        <td align="center"><img src="../images/submitn.gif" border="0" onclick="window.close();" style="cursor: pointer;"></td>
	    <% } %>
	</tr>
</table>
</body>
