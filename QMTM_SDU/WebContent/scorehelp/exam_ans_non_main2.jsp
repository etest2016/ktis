	...
	<tr>
		<td align="center" >
			<table border='0' width='95%'>
				<tr>
					<td align="left"><font color="#336600"><B>■</font> 답안비교 결과</B></td>
					<td align="right">
			...
			<table border='0' cellspacing='1' cellpadding='3' width='95%' bgcolor='#EEEEEE'>
			  <tr height="25">    
				<td width="20%" align="right" bgcolor="#E0E0E0"><B>원본 응시자</B>&nbsp;</td>      
				<td width="30%" align="left" bgcolor="#FFFFFF">&nbsp;<B><%=o_userid%></B></td>      
				<td width="20%" align="right" bgcolor="#E0E0E0"><B>비교 응시자</B>&nbsp;</td>      
				<td width="30%" align="left" bgcolor="#FFFFFF">&nbsp;<B><%=t_userid%></B></td>      
			  </tr>

			  <tr height="25">    
				<td width="20%" align="right" bgcolor="#E0E0E0"><B>답안길이</B>&nbsp;</td>      
			  ...
			  <tr height="25">    
				<td width="20%" align="right" bgcolor="#E0E0E0"><B>답안저장시간</B>&nbsp;</td>      
			  ...
			  <tr>    
				<td width="45%" bgcolor="#FFFFFF" height="200" colspan="2"><%= SearchCa %></td>  
				<td width="45%" bgcolor="#FFFFFF" height="200" colspan="2"><%= sResultAns %></td>  
			  </tr>
			</table>
		</td>
	</tr>
