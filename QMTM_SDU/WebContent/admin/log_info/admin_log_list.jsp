...
<BODY id="tman">
	...
	<div id="main">
		...
		<div id="mainTop">
			<div class="title">Admin로그관리 <span>검색할 일자를 입력하면 Admin관련로그를 확인할 수 있습니다.</span></div>
			<div class="location">ADMIN ><span> 퀴즈출제현황및로그관리 > Admin로그관리</span></div>
		</div>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" id="tableA">
			...
			<tr bgcolor="#FFFFFF" align="center" height="30" id="tr">
				...
				<td bgcolor="#D8D8D8">대메뉴</td>
				<td bgcolor="#D8D8D8">중메뉴</td>
				<td bgcolor="#D8D8D8">소메뉴</td>				
...
<% if(rst == null) {%>
			<tr bgcolor="#FFFFFF" height="40">
				<td class="blank" align="center" colspan="9">검색조건을 입력하세요..</td>
			</tr>
<% 
	} else { 
