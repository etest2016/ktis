...
<script language="javascript">
	...
	if(node_gubun == "G1") {
		location.href = "midcategory/midcategory_list.jsp?id_category=<%=id_node%>";
	} else if(node_gubun == "M1") {
		location.href = "midcategory/course_list.jsp?id_midcategory=<%=id_node%>";
	} 
</script>   