  ...
  <script type="text/javascript" src="../../js/jquery.etest.poster.js"></script>
	<script language="javascript">
		function exam_view(id_exam) {
			$.posterPopup('../../tman/exam/exam_view.jsp?id_exam='+id_exam,'exam_view','width=850, height=700, scrollbars=yes, top='+(screen.height-700)/2+', left='+(screen.width-850)/2);
	    }
				...
				<TD valign="top" align="left" width="14.3%">
					<table border="0">
						<%
							...
							try {
								rst = ExamSchedule.getBeans(String.valueOf(year), months, days);
							} catch(Exception ex) {
