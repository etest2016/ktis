...
<BODY id="tman">
	...
	<div id="main">
		...
		<div id="mainTop">
			<div class="title">과목별 퀴즈미응시현황 <span>과목별 퀴즈미응시현황을 확인할 수 있습니다.</span></div>
			<div class="location">퀴즈통계관리 ><span> 과목별 퀴즈미응시현황</span></div>
		</div>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" id="tableA">
			...
			<tr bgcolor="#FFFFFF" align="center" height="30" id="tr">
				...
				<td bgcolor="#D8D8D8">전체주차</td>
				<td bgcolor="#D8D8D8">미응시주차</td>
				<td bgcolor="#D8D8D8">미응시율</td>				
			</tr>
