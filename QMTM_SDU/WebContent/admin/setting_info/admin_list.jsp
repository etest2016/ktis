...
<HTML>
 ...
 <BODY id="admin">	
	...
	<div id="main">
		...
		<div id="mainTop">
			<div class="title">시스템관리자 관리<span>: 시스템관리자 추가, 수정, 삭제 관리</span></div>
			<div class="location">ADMIN > 설정관리 > <span>시스템관리자 관리</span></div>
		</div>

		<table border="0" cellpadding ="0" cellspacing="0" id="tableA">
			<tr id="bt"><Td colspan="8"><input type="button" value="관리자 등록" class="form5" onClick="insert();">&nbsp;&nbsp;<b>교직원아이디를 클릭하면 관리자 정보를 수정/삭제 할 수 있습니다.</b></td></tr>
			<tr id="tr">
				<td width="4%">NO</td>
				<td width="15%">교직원아이디</td>
				<td width="15%">성명</td>				
				<td>소속정보</td>
				<td width="12%">사용여부</td>
				<td width="10%">등록일자</td>
			...
			<% if(rst == null) { %>
			<tr>
				<td class="blank" colspan="6">등록되어진 시스템관리자가 없습니다.</td>
			</tr>
			<%
			   } else {
