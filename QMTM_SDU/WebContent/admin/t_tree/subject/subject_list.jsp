...
<HTML>
 ...
 <script language="JavaScript">
	function sub_edit() {
		$.posterPopup("subject_edit.jsp?id_course=<%=id_course%>&id_subject=<%=id_subject%>","edit","width=400, height=250, scrollbars=no");
	}
    ...
    function sub_delete()  {
	   ...
	   if (st == true) {
           $.posterPopup("subject_delete.jsp?id_course=<%=id_course%>&id_subject=<%=id_subject%>&bigo=Y","edit","width=400, height=250, scrollbars=no");
       }
    }	
 </script>
