...
<div id="top">
	...
	<div id="contents" style="text-align: center;">
		<table style="border: 2px solid #ddd;">
			<tr height="50">
				...
				<td><img onclick="sends()" src="../../images/bt5_sjinsert_yj2_1.gif" border="0" style=cursor:pointer;>&nbsp;&nbsp;&nbsp;</td>
			</tr>
		</table>
		</div>
	...
	<div id="button">
		<img onclick="window.close();" src="../../images/bt5_exit_yj1.gif" style="cursor:pointer">
	</div>
