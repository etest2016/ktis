...
<HTML>
 ...
 <BODY id="popup2">
	...
	<div id="button">
		<% if(rst != null) { %><img onClick="checks();" src="../../images/bt_sja_1.gif" style="cursor:pointer"><% } %>&nbsp;&nbsp;<img src="../../images/bt_close_1.gif" align="top" style="cursor:pointer" onClick="window.close();">
	</div>
