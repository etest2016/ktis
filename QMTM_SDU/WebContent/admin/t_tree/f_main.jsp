...
<HTML>
 ...
 <script language="JavaScript">
	function sub_insert() {
		$.posterPopup("course_insert.jsp?id_category=<%=id_category%>","insert","width=400, height=250, scrollbars=no");
    }

	function sub_view(id_course) {
		$.posterPopup("course/course_view.jsp?id_category=<%=id_category%>&id_course="+id_course,"view","width=400, height=250, scrollbars=no");
    }
 </script>
