...
Function Show_cal(sYear,sMonth,sDay)
	...
	Cal_HTML = Cal_HTML& "<td width='15' align=left  title='이전년도' style='cursor:pointer;' OnClick='vbscript:call Show_cal("&intPrevYear-1&","&intPrevMonth+1&",1)'><font COLOR='#777777' class='s'>◀</font></td>"
	Cal_HTML = Cal_HTML& "<td width='15' align=left  title='이전달' style='cursor:pointer;' OnClick='vbscript:call Show_cal("&intPrevYear&","&intPrevMonth&",1)'><font COLOR='#777777' class='s'>◀</font></td>"
	Cal_HTML = Cal_HTML& "<td width='117' align='center' class='s1'>" 
	Cal_HTML = Cal_HTML& intThisYear&"년 "&intThisMonth&"월" & "</td>"
	Cal_HTML = Cal_HTML& "<td width='15' align=right title='다음달' style='cursor:pointer;' OnClick='vbscript:call Show_cal("&intNextYear&","&intNextMonth&",1)'><font COLOR='#777777' class='s'>▶</font></td>"        
	Cal_HTML = Cal_HTML& "<td width='15' align=right title='다음년도' style='cursor:pointer;' OnClick='vbscript:call Show_cal("&intNextYear+1&","&intNextMonth-1&",1)'><font COLOR='#777777' class='s'>▶</font></td>"        
		...
		For intLoopDay = 1 To 7		'요일단위 루프 시작, 일요일부터
			...
			Else
				...
				Else					'입력날짜가 현재월에 해당되면
					...
					Cal_HTML=Cal_HTML& "<td title='" & ResultStr & "' style='cursor: pointer;border: 1px solid white;width:18; height:18;"
