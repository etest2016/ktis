<%
//******************************************************************************
//   프로그램 : q_standardA.jsp
//   모 듈 명 : 대분류 관리
//   설    명 : 대분류 목록 및 추가,수정,삭제
//   테 이 블 : q_standard_a, t_worker_subj
 ...
 <BODY id="admin">	
	...
	<div id="main">
		...
		<table border="0" cellpadding ="0" cellspacing="0" id="tableA">
			<tr id="bt"><Td colspan="7"><input type="button" value="대분류 기준등록" class="form6" onClick="insert();">&nbsp;&nbsp;<b>대분류명을 클릭하면 소분류 기준을 등록할 수 있습니다.</b></td></tr>
			<tr id="tr">
				<td width="5%">NO</td>
				<td width="15%">대분류코드</td>
				<td>대분류명</td>
				<td width="15%">공개여부</td>
				<td width="15%">등록일자</td>
				<td width="15%">관리</td>
			...
			<% if(rst == null) { %>
			<tr>
				<td class="blank" colspan="6">등록되어진 대분류 기준이 없습니다.</td>
			</tr>
			<%
			   } else {
			...
			<tr id="td" align="center">
				...
				<td><input type="button" value="수정하기" class="form" onClick="edits('<%=rst[i].getId_standarda()%>');">&nbsp;&nbsp;<input type="button" value="삭제하기" class="form" onClick="dels('<%=rst[i].getId_standarda()%>');"></td>
			</tr>
			<%
				   }
				}
