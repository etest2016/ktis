			...
			<td width="500" align="left" valign="top" bgcolor="ffffff">
				...
				<div id="id_q">
					...
					<table border="0" width="97%" cellspacing="0" cellpadding="0" align="center">
						<tr>
							<td height=25 valign="top"><input type="checkbox" name="yn_ex_set" value="Y"> <B>문제출제시 보기섞기 금지</B></td>
						</tr>
					</table>					
					<% } %>
...
예를 들어 정답이 '인간' 이라고 하면 '사람' 이라는 단어도 정답으로 인정된다고 생각되면 모두 입력하세요.</textarea></td>
										...
										<tr height="30">
											<td colspan="2">정답 입력 텍스트 박스 크기 : <input type="text" class="input" name="ans_size<%=i+1%>" size="4" value="20"></td>
										</tr>						
										<tr height="30">
											<td colspan="2">앞 메시지 : <input type="text" class="input" name="front_msg<%=i+1%>" size="43"></td>
										</tr>
										<tr height="30">
										<td colspan="2">뒷 메시지 : <input type="text" class="input" name="back_msg<%=i+1%>" size="43"></td>
										</tr>
									</table>
									<% } %>
									</td>
								...
								<tr>
									...
									<table width="100%" border="0">
										...
										<tr>
											<td align="left" width="100%"><textarea cols="65" rows="6">※ 정답순서 
...
예)  정답이 '단답형 정답 입력' 이고, '띄어쓰기 구분 있음' 으로 할 경우 '단답형정답 입력' 으로 답안을 제출하면 틀린 답안으로 채점이 됩니다.</textarea>
					...
					<tr bgcolor="#FFFFFF">
						<td width="525" valign="top" colspan="2"><input type="checkbox" name="yn_practice" value="Y"> <B>실기형 문제로 출제</B><BR><BR><B>'실기형 문제로 출제' 에 체크하면 응시자 시험지에<BR>답안 입력하는 박스가 나타나지 않는 형태로 출제됩니다.</B></td>
					</tr>
					<% } %>
				</table>
				</div>
			...
			<div style="display:;" id="id_refbody">
				...
				<table border="0" border="0" width="95%" cellspacing="0" cellpadding="0" align="center">
					<tr height="30">
						<td bgcolor="FFFFFF" align="left"><input type="button" value="지문초기화" class="form2" onClick="q_refs_init();">&nbsp;&nbsp;<input type="button" value="기존지문선택" class="form2" onClick="q_refs();"></td>			
					</tr>					
					<tr height="25">
			...
			<div style="display:;" id="id_infos"> 
				...
				<table border="0" border="1" width="95%" cellspacing="0" cellpadding="3" id="tableD" align="center">
					...
					<tr>
						...
						<td bgcolor="FFFFFF" align="right" width="22%" id="left">1줄표시보기수</td>
