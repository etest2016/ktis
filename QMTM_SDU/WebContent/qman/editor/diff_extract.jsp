...
<%
	...
	String diff0 = request.getParameter("a");
	String diff1 = request.getParameter("b");
	String diff2 = request.getParameter("c");
	String diff3 = request.getParameter("d");
	String diff4 = request.getParameter("e");
	String diff5 = request.getParameter("f");
%>
