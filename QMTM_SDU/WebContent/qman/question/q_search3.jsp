...
<%
	...
	if (id_subject.length() == 0 || id_chapter.length() == 0 || id_chapter2.length() == 0 || id_chapter3.length() == 0) {
	...
	if(bigos.equals("Y")) {
		...
		try {
			rst = QSearch.getSearchBeans(bean, id_subject, id_chapter, id_chapter2, id_chapter3, userid);
		} catch(Exception ex) {
...
<html>
  ...
  <script type="text/javascript" src="../../js/jquery.etest.poster.js"></script>
	...
	<form name="form1" method="post" action="q_search3.jsp">
	...
	<div id="contents">
		...
		<BR>
			...
			<tr bgcolor="#FFFFFF" height="40">
				<td colspan="5" align="center"  class="blank">검색되어진 문제가 없습니다.</td>
			</tr>
			<%
				} else {
