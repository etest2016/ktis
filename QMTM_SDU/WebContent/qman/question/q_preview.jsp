...
//   설    명 : 문제 미리보기
//   테 이 블 : q
//   자바파일 : qmtm.ComLib, qmtm.QmTm, qmtm.tman.exam.QunitBean, qmtm.tman.exam.Qunit
//   작 성 일 : 2013-02-08
//   작 성 자 : 이테스트 석준호
//   수 정 일 : 
//   수 정 자 : 
...
<BODY id="popup2">
	...
	<div id="top">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<Td id="left"></td>
				<Td id="mid"><div class="title">문제미리보기 </div></td>
				<Td id="right"></td>
			</tr>
		</table>
	</div>
	...
	<div id="button">
		<input type="button" value="창닫기" class="form" onClick="window.close();">
	</div>
