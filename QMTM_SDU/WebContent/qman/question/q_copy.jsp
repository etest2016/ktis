...
<BODY id="popup2">
	...
	<div id="button">
		<a href="javascript:Send();"><img src="../../images/bt_q_copy_yj1.gif"></a>&nbsp;&nbsp;<!--input type="button" value="취소하기" onClick="window.close();"--><a href="javascript:window.close();"><img border="0" src="../../images/user_static_yj1_2.gif">
	</div>
