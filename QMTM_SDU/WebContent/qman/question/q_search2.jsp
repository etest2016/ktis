...
<%
	...
	if (id_subject.length() == 0 || id_chapter.length() == 0 || id_chapter2.length() == 0) {
	...
	if(bigos.equals("Y")) {
		...
		try {
			rst = QSearch.getSearchBeans(bean, id_subject, id_chapter, id_chapter2, userid);
		} catch(Exception ex) {
...
<html>
  ...
  <script type="text/javascript" src="../../js/jquery.etest.poster.js"></script>
	...
	<form name="form1" method="post" action="q_search2.jsp">
