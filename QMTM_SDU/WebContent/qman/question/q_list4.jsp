...
<%    
    ...
    try {
	    rst = QListUtil.getUBeans(userid, names.getId_subject(), names.getId_chapter1(), names.getId_chapter2(), names.getId_chapter3(), names.getId_chapter4());
    } catch(Exception ex) {
	    out.println(ComLib.getExceptionMsg(ex, "back"));
...
<HTML>
 <HEAD>
  ...
  <!--
	...
	function m1_1_pop() {
		$.posterPopup("q_qtype.jsp?id_q_subject=<%=names.getId_subject()%>&id_q_chapter=<%=names.getId_chapter1()%>&id_q_chapter2=<%=names.getId_chapter2()%>&id_q_chapter3=<%=names.getId_chapter3()%>&id_q_chapter4=<%=names.getId_chapter4()%>","QInsert","width=500,height=500,scrollbars=yes");
	}
	...
	function cpt_view() {
		...
		$.posterPopup("../../admin/q_tree/chapter4/chapter_view.jsp?id_subject=<%=names.getId_subject()%>&id_chapter1=<%=names.getId_chapter1()%>&id_chapter2=<%=names.getId_chapter2()%>&id_chapter3=<%=names.getId_chapter3()%>&id_q_chapter=<%=id_q_chapter%>","view","width=400, height=250, scrollbars=no");
    }
	...
	function q_info() {
		...
		var frmx = document.form1;
		 ...
		 if(k == 0) {
			 ...
			 $.posterPopup("q_info_edit.jsp?id_qs="+selectId.substring(0,selectId.length-1),"info_q","top=0, left=0, width=520, height=50");
		 }
	}
	...
	function q_preview() {
	 ...
	 function q_search() {
		$.posterPopup("q_search4.jsp?id_subject=<%=names.getId_subject()%>&id_chapter=<%=names.getId_chapter1()%>&id_chapter2=<%=names.getId_chapter2()%>&id_chapter3=<%=names.getId_chapter3()%>&id_chapter4=<%=names.getId_chapter4()%>","q_search","width=1000, height=600, scrollbars=yes");
	 }
	...
	<div id="main">
		...
		<table border="0" cellpadding ="0" cellspacing="0">
			<tr>
				...
				<td onclick="javascript:cpt_view();"><img src="../../images/bt6_qman_3.gif" style="cursor: pointer;"></td>
		...
		<table border="0" width="100%">
			<tr>
				...
				<td align="right"><b>▶ <font color="blue"> <%=names.getSubject()%> > <%=names.getChapter1()%> > <%=names.getChapter2()%> > <%=names.getChapter3()%> > </font></b><span><b> <font color="red" size="3"><%=names.getChapter4()%></font><b></span></div></td>
