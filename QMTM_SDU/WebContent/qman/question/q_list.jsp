...
<HTML>
 <HEAD>
  ...
  <!--
	...
	function QSearch(){
		$.posterPopup("q_search.jsp?id_q_subject=<%=id_q_subject%>","QSearch","width=900,height=650, scrollbars=yes");
	}
 ...
 <BODY onLoad = "selects();" id="qman">
	<div id="main">
		...
		<tr height="30">
			<td align="right">검색된 문제 수 : <input type="text" class="input" name="search_cnt" size="6">&nbsp;문제&nbsp;&nbsp;</td>
		</tr>
		</table>
		</form>
	</div>
