...
<meta http-equiv="Content-Type" content="text/html; charset=EUC-KR">
	...
	<table border="1" cellpadding ="0" cellspacing="0" >
		<tr height="40" align="center">
			...
			<td align="center" bgcolor="#9DBFFF">정답률</td>
			<td align="center" bgcolor="#9DBFFF">출제횟수</td>			
			<td align="center" bgcolor="#9DBFFF">입력자</td>
			<td align="center" bgcolor="#9DBFFF">문제용도</td>
			<td align="center" bgcolor="#9DBFFF">검색키워드</td>
			<td align="center" bgcolor="#9DBFFF">문제상태</td>
